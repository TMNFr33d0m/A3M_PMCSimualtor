		...
		maxSpeed               	= 75; 		/// vehicle can go a bit over, but dramatically decreases thrust
		fuelCapacity           	= 45; 
		wheelCircumference     	= 0.875; 	/// diameter of 725
		...
		idleRpm = 400; // RPM at which the engine idles.
		...
		{	
			...
			driveString        = "F"; // string to display in the HUD for forward gears.
			neutralString      = "S"; // string to display in the HUD for neutral gear.
			reverseString      = "B"; // string to display in the HUD for reverse gears.
