...
EnPres= EnChance select floor random count EnChance;
		if (EnPres == 1) then {
		SARWen= [getMarkerPos NSARDestNo, EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_AutoRifleman","A3M_APFC_ME_Rifleman_AT","A3M_APFC_ME_Rifleman_2","A3M_APFC_ME_Rifleman_2","A3M_APFC_ME_Rifleman_AT"]] call BIS_fnc_spawnGroup;
...
NSARen= [getMarkerPos "nur", EAST, ["A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_Rifleman_1", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_AutoRifleman","A3M_APFC_ME_Rifleman_AT","A3M_APFC_ME_Rifleman_2","A3M_APFC_ME_Rifleman_2","A3M_APFC_ME_Rifleman_AT"]] call BIS_fnc_spawnGroup;
