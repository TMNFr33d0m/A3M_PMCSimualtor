...
RCPickedNumber= RCRandomNumber select floor random count RCRandomNumber; 
	switch (RCPickedNumber) do {
		...
		if (EnPres == 1) then {
		_RBen= [getMarkerPos "ENStage1", EAST, ["A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_Rifleman_2", "A3M_APFC_ME_AutoRifleman", "A3M_APFC_ME_Rifleman_Elite", "A3M_APFC_ME_Rifleman_AT"]] call BIS_fnc_spawnGroup;
