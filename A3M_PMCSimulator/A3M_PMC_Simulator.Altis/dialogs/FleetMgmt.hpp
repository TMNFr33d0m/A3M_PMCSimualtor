...
class A3M_StoreFrame: RscFrame
{
	...
	idc = 1800;
	text = "Яндекс Браузер V 1.69.420"; //--- ToDo: Localize;
...
{
	idc = 1000;
	text = "Бюджет операции:"; //--- ToDo: Localize;
...
{
	idc = 1001;
	text = "Итоговая цена операции:"; //--- ToDo: Localize;
...
{
	idc = 1002;
	text = "Информация о ранге:"; //--- ToDo: Localize;
...
class A3M_SelectWheeled: RscButton
{
	...
	idc = 1604;
	text = "Доставка автомобилей"; //--- ToDo: Localize;
...
class A3M_VehMod: RscCombo
{
	...
	idc = 2175;
	text = "Поддерживаемые моды на технику"; //--- ToDo: Localize;
	x = 0.658396 * safezoneW + safezoneX;
	y = 0.315162 * safezoneH + safezoneY;
	w = 0.206312 * safezoneW;
	h = 0.0330081 * safezoneH;
	tooltip = "Выберите поддерживаемую модификацию, затем кликните на категорию"; //--- ToDo: Localize;
};
class A3M_ModTxt: RscText
{
	idc = 1003;
	text = "Поддержеваемые модификации: "; //--- ToDo: Localize;
...
class A3M_Btn_Prch: RscButton
{
	...
	w = 0.0674073 * safezoneW;
	h = 0.0330067 * safezoneH;
	tooltip = "Заказать выбранное "; //--- ToDo: Localize;
};
class A3M_Btn_Robotics: RscButton
{
	...
	idc = 1602;
	text = "Робототехника и БПЛА"; //--- ToDo: Localize;
	x = 0.430347 * safezoneW + safezoneX;
	y = 0.422984 * safezoneH + safezoneY;
	w = 0.0674073 * safezoneW;
	h = 0.0330067 * safezoneH;
	tooltip = "Автономное оборудование"; //--- ToDo: Localize;
};
class A3M_Btn_Sprt: RscButton
{
	...
	w = 0.0617901 * safezoneW;
	h = 0.0330067 * safezoneH;
	tooltip = "Флот и персональная поддержка "; //--- ToDo: Localize;
};
class A3M_Btn_Upgrades: RscButton
{
	...
	idc = 1608;
	text = "Улучшения"; //--- ToDo: Localize;
	x = 0.570776 * safezoneW + safezoneX;
	y = 0.422984 * safezoneH + safezoneY;
	w = 0.0674073 * safezoneW;
	h = 0.0330067 * safezoneH;
	tooltip = "Улучшения базы"; //--- ToDo: Localize;
};
////////////////////////////////////////////////////////
