...
if (RHS_Support_Enabled == 1) then {
_index8=lbAdd	[1500,	"USA (Desert)  AH-1Z (Multi-Role) 								Price: 	$27,550,000.00	"	];		_Pic1	=	getText	(	configFile >>	"CfgVehicles"	>>	"RHS_AH1Z">>	"picture");	lbSetPicture	[	1500	,	8	,	_Pic1	];	lbSetColor	[	1500	,	8	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index9=lbAdd	[1500,	"USA (Desert)  AH-1Z (Ground-Suppression)						Price: 	$27,150,000.00	"];		_Pic2	=	getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_GS">>	"picture");	lbSetPicture	[	1500	,	9	,	_Pic2	];	lbSetColor	[	1500	,	9	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index10=lbAdd	[1500,	"USA (Desert)  AH-1Z (Close-Support) 							Price: 	$27,350,000.00	"];		_Pic3=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_CS">>	"picture");	lbSetPicture	[	1500	,	10	,	_Pic3	];	lbSetColor	[	1500	,	10	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index11=lbAdd	[1500,	"USA (Woodland)  AH-1Z (Multi-Role) 							Price: 	$31,550,000.00	"];		_Pic4=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd">>	"picture");	lbSetPicture	[	1500	,	11	,	_Pic4	];	lbSetColor	[	1500	,	11	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index12=lbAdd	[1500,	"USA (Woodland)  AH-1Z (Ground-Suppression)						Price: 	$31,150,000.00	"];		_Pic5=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_gs">>	"picture");	lbSetPicture	[	1500	,	12	,	_Pic5	];	lbSetColor	[	1500	,	12	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index13=lbAdd	[1500,	"USA (Woodland)  AH-1Z (Close-Support)							Price: 	$31,350,000.00	"];		_Pic6=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_cs">>	"picture");	lbSetPicture	[	1500	,	13	,	_Pic6	];	lbSetColor	[	1500	,	13	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index14=lbAdd	[1500,	"USA (Army 2010)  AH-64D (grey) 								Price: 	$65,325,950.00	"];		_Pic7=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64DGrey">>	"picture");	lbSetPicture	[	1500	,	14	,	_Pic7	];	lbSetPictureColor	[	1500	,	14	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index15=lbAdd	[1500,	"USA (Army 2014)  AH-64D (Multi-Role) 							Price: 	$35,950,000.00	"];		_Pic8=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd">>	"picture");	lbSetPicture	[	1500	,	15	,	_Pic8	];	lbSetPictureColor	[	1500	,	15	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index16=lbAdd	[1500,	"USA (Army 2014)  AH-64D (Ground-Suppression)					Price: 	$35,725,950.00	"];		_Pic9=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_gs">>	"picture");	lbSetPicture	[	1500	,	16	,	_Pic9	];	lbSetPictureColor	[	1500	,	16	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index17=lbAdd	[1500,	"USA (Army 2014)  AH-64D (Close-Support) 						Price: 	$35,695,500.00	"];		_Pic10=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_cs">>	"picture");	lbSetPicture	[	1500	,	17	,	_Pic10	];	lbSetPictureColor	[	1500	,	17	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index18=lbAdd	[1500,	"USA (Army 2014)  AH-64D (AA) 									Price: 	$35,725,950.00	"];		_Pic11=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64D_wd_AA">>	"picture");	lbSetPicture	[	1500	,	18	,	_Pic11	];	lbSetPictureColor	[	1500	,	18	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index19=lbAdd	[1500,	"USA (Army 2010)  CH-47 										Price: 	$38,550,000.00	"];		_Pic12=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_10">>	"picture");	lbSetPicture	[	1500	,	19	,	_Pic12	];	lbSetPictureColor	[	1500	,	19	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index20=lbAdd	[1500,	"USA (Army 2010)  CH-47 (D)										Price: 	$38,550,000.00	"];		_Pic13=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light_10">>	"picture");	lbSetPicture	[	1500	,	20	,	_Pic13	];	lbSetPictureColor	[	1500	,	20	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index21=lbAdd	[1500,	"USA (Army 2014)  CH-47											Price: 	$38,550,000.00	"];		_Pic14=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f">>	"picture");	lbSetPicture	[	1500	,	21	,	_Pic14	];	lbSetPictureColor	[	1500	,	21	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index22=lbAdd	[1500,	"USA (Army 2014)  CH-47 (D)										Price: 	$38,550,000.00	"];		_Pic15=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light">>	"picture");	lbSetPicture	[	1500	,	22	,	_Pic15	];	lbSetPictureColor	[	1500	,	22	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index23=lbAdd	[1500,	"USA (USMC 2010)  UH-1Y (FFAR/MG)								Price: 	$21,600,000.00	"];		_Pic16=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y">>	"picture");	lbSetPicture	[	1500	,	23	,	_Pic16	];	lbSetPictureColor	[	1500	,	23	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index24=lbAdd	[1500,	"USA (USMC 2010)  UH-1Y (FFAR) 								   Price: 	$21,600,000.00	"];		_Pic17=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_ffar">>	"picture");	lbSetPicture	[	1500	,	24	,	_Pic17	];	lbSetPictureColor	[	1500	,	24	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index25=lbAdd	[1500,	"USA (USMC 2010)  UH-1Y (Unarmed) 							   Price: 	$21,600,000.00	"];		_Pic18=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_unarmed">>	"picture");	lbSetPicture	[	1500	,	25	,	_Pic18	];	lbSetPictureColor	[	1500	,	25	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index26=lbAdd	[1500,	"USA (Army 2014)  UH-60M 									   Price: 	$21,300,000.00	"];		_Pic19=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m">>	"picture");	lbSetPicture	[	1500	,	26	,	_Pic19	];	lbSetPictureColor	[	1500	,	26	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index27=lbAdd	[1500,	"USA (Army 2014)  UH-60M MEV 								   Price: 	$21,300,000.00	"];		_Pic20=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev2">>	"picture");	lbSetPicture	[	1500	,	27	,	_Pic20	];	lbSetPictureColor	[	1500	,	27	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index28=lbAdd	[1500,	"USA (Army 2014)  UH-60M MEV (ESSS)							   Price: 	$21,300,000.00	"];		_Pic21=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev">>	"picture");	lbSetPicture	[	1500	,	28	,	_Pic21	];	lbSetPictureColor	[	1500	,	28	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
