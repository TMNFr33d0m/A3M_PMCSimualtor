...
_index21 =lbAdd   [1575,"USA (Армия США - Лес ) Хамви(Хаммер) (Без вооружения)                Цена:    $74,969.00"]; _Pic22= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w">> "picture");  lbSetPicture    [1575, 21   , _Pic22  ];  lbSetPictureColor   [1575, 21,[0.738,0.714,0.417,1 ]];
_index22 =lbAdd   [1575,"USA (Армия США - Пустыня ) Хамви(Хаммер) (Без вооружения)            Цена:    $74,969.00"]; _Pic23= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d">> "picture");  lbSetPicture    [1575, 22   , _Pic23  ];  lbSetPictureColor   [1575, 22,[0.738,0.714,0.417,1 ]];
_index23 =lbAdd   [1575,"USA (МП США - Лес ) Хамви(Хаммер) (Без вооружения/АГУ)               Цена:    $75,969.00"]; _Pic24= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s">> "picture");   lbSetPicture    [1575, 23   , _Pic24  ];  lbSetPictureColor   [1575, 23,[0.738,0.714,0.417,1 ]];
_index24 =lbAdd   [1575,"USA (МП США - Пустыня ) Хамви(Хаммер) (Без вооружения/АГУ)           Цена:    $75,969.00"]; _Pic25= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s">> "picture");   lbSetPicture    [1575, 24   , _Pic25  ];  lbSetPictureColor   [1575, 24,[0.738,0.714,0.417,1 ]];
_index25 =lbAdd   [1575,"USA (Армия США - Лес ) Хамви(Хаммер) (M2)                            Цена:    $84,969.00"]; _Pic26= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_m2">> "picture");   lbSetPicture    [1575, 25   , _Pic26  ];  lbSetPictureColor   [1575, 25,[0.738,0.714,0.417,1 ]];
_index26 =lbAdd   [1575,"USA (Армия США - Пустыня ) Хамви(Хаммер) (M2)                        Цена:    $84,969.00"]; _Pic27= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d_m2">> "picture");  lbSetPicture    [1575, 26   , _Pic27  ];  lbSetPictureColor   [1575, 26,[0.738,0.714,0.417,1 ]];
_index27 =lbAdd   [1575,"USA (МП США - Лес ) Хамви(Хаммер) (M2/АГУ)                           Цена:    $85,969.00"]; _Pic28= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s_m2">> "picture");    lbSetPicture    [1575, 27   , _Pic28  ];  lbSetPictureColor   [1575, 27,[0.738,0.714,0.417,1 ]];
_index28 =lbAdd   [1575,"USA (МП США - Пустыня ) Хамви(Хаммер) (M2/АГУ)                       Цена:    $85,969.00"]; _Pic29= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d_s_m2">> "picture");    lbSetPicture    [1575, 28   , _Pic29  ];  lbSetPictureColor   [1575, 28,[0.738,0.714,0.417,1 ]];
_index29 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2                                      Цена:   $200,000.00"]; _Pic30= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 29   , _Pic30  ];  lbSetPictureColor   [1575, 29,[0.738,0.714,0.417,1 ]];
_index30 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2 (Открытый)                           Цена:   $200,000.00"]; _Pic31= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_open_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 30   , _Pic31  ];  lbSetPictureColor   [1575, 30,[0.738,0.714,0.417,1 ]];
_index31 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2 (Открытый без тентовой основы)       Цена:   $200,000.00"]; _Pic32= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 31   , _Pic32  ];  lbSetPictureColor   [1575, 31,[0.738,0.714,0.417,1 ]];
_index32 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B                                    Цена:   $200,500.00"]; _Pic33= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 32   , _Pic33  ];  lbSetPictureColor   [1575, 32,[0.738,0.714,0.417,1 ]];
_index33 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B (Открытый)                         Цена:   $200,500.00"]; _Pic34= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_open_fmtv_usarmy">> "picture");  lbSetPicture    [1575, 33   , _Pic34  ];  lbSetPictureColor   [1575, 33,[0.738,0.714,0.417,1 ]];
_index34 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B (Открытый без тентовой основы)     Цена:   $200,500.00"]; _Pic35= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_flatbed_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 34   , _Pic35  ];  lbSetPictureColor   [1575, 34,[0.738,0.714,0.417,1 ]];
_index35 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B (M2)                               Цена:   $210,000.00"]; _Pic36= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 35   , _Pic36  ];  lbSetPictureColor   [1575, 35,[0.738,0.714,0.417,1 ]];
_index36 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B (M2/Открытый)                      Цена:   $210,000.00"]; _Pic37= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_open_fmtv_usarmy">> "picture");  lbSetPicture    [1575, 36   , _Pic37  ];  lbSetPictureColor   [1575, 36,[0.738,0.714,0.417,1 ]];
_index37 =lbAdd   [1575,"USA (Армия США 2014)  M1078A1P2-B (M2/Открытый без тентовой основы)  Цена:   $210,000.00"]; _Pic38= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_flatbed_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 37   , _Pic38  ];  lbSetPictureColor   [1575, 37,[0.738,0.714,0.417,1 ]];
_index38 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2                                      Цена:   $200,000.00"]; _Pic39= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 38   , _Pic39  ];  lbSetPictureColor   [1575, 38,[0.738,0.714,0.417,1 ]];
_index39 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2 (Открытый)                           Цена:   $200,000.00"]; _Pic40= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_open_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 39   , _Pic40  ];  lbSetPictureColor   [1575, 39,[0.738,0.714,0.417,1 ]];
_index40 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2 (Открытый без тентовой основы)       Цена:   $200,000.00"]; _Pic41= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 40   , _Pic41  ];  lbSetPictureColor   [1575, 40,[0.738,0.714,0.417,1 ]];
_index41 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B                                    Цена:   $200,500.00"]; _Pic42= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 41   , _Pic42  ];  lbSetPictureColor   [1575, 41,[0.738,0.714,0.417,1 ]];
_index42 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B (Открытый)                         Цена:   $200,500.00"]; _Pic43= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_open_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 42   , _Pic43  ];  lbSetPictureColor   [1575, 42,[0.738,0.714,0.417,1 ]];
_index43 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B (Открытый без тентовой основы)     Цена:   $200,500.00"]; _Pic44= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 43   , _Pic44  ];  lbSetPictureColor   [1575, 43,[0.738,0.714,0.417,1 ]];
_index44 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B (M2)                               Цена:   $210,000.00"]; _Pic45= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 44   , _Pic45  ];  lbSetPictureColor   [1575, 44,[0.738,0.714,0.417,1 ]];
_index45 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B (M2/Открытый)                      Цена:   $210,000.00"]; _Pic46= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_open_fmtv_usarmy_10">> "picture");    lbSetPicture    [1575, 45   , _Pic46  ];  lbSetPictureColor   [1575, 45,[0.738,0.714,0.417,1 ]];
_index46 =lbAdd   [1575,"USA (Армия США 2010)  M1083A1P2-B (M2/Открытый без тентовой основы)  Цена:   $210,000.00"]; _Pic47= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy_10">> "picture");    lbSetPicture    [1575, 46   , _Pic47  ];  lbSetPictureColor   [1575, 46,[0.738,0.714,0.417,1 ]];
_index47 =lbAdd   [1575,"USA (Армия США - Лес )  Хамви(Хаммер) , 2-х Дверный открытый         Цена:    $61,665.00"]; _Pic48= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr">> "picture");  lbSetPicture    [1575, 47   , _Pic48  ];  lbSetPictureColor   [1575, 47,[0.738,0.714,0.417,1 ]];
_index48 =lbAdd   [1575,"USA (Армия США - Пустыня )  Хамви(Хаммер) , 2-х Дверный открытый     Цена:    $61,665.00"]; _Pic49= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr">> "picture");   lbSetPicture    [1575, 48   , _Pic49  ];  lbSetPictureColor   [1575, 48,[0.738,0.714,0.417,1 ]];
_index49 =lbAdd   [1575,"USA (Армия США - Лес )  Хамви(Хаммер) , 2-х Дверный полукрытый       Цена:    $63,665.00"]; _Pic50= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr_halftop">> "picture");   lbSetPicture    [1575, 49   , _Pic50  ];  lbSetPictureColor   [1575, 49,[0.738,0.714,0.417,1 ]];
_index50 =lbAdd   [1575,"USA (Армия США - Пустыня )  Хамви(Хаммер) , 2-х Дверный полукрытый   Цена:    $63,665.00"]; _Pic51= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr_halftop">> "picture");   lbSetPicture    [1575, 50   , _Pic51  ];  lbSetPictureColor   [1575, 50,[0.738,0.714,0.417,1 ]];
_index51 =lbAdd   [1575,"USA (Армия США - Лес )  Хамви(Хаммер) , 2-х Дверный крытый           Цена:    $65,665.00"]; _Pic52= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr_fulltop">> "picture");   lbSetPicture    [1575, 51   , _Pic52  ];  lbSetPictureColor   [1575, 51,[0.738,0.714,0.417,1 ]];
_index52 =lbAdd   [1575,"USA (Армия США - Пустыня )  Хамви(Хаммер) , 2-х Дверный крытый       Цена:    $65,665.00"]; _Pic53= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr_fulltop">> "picture");   lbSetPicture    [1575, 52   , _Pic53  ];  lbSetPictureColor   [1575, 52,[0.738,0.714,0.417,1 ]];
_index53 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 2-х Дверный открытый, АГУ        Цена:    $61,665.00"]; _Pic54= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr">> "picture");    lbSetPicture    [1575, 53   , _Pic54  ];  lbSetPictureColor   [1575, 53,[0.738,0.714,0.417,1 ]];
_index54 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 2-х Дверный открытый, АГУ    Цена:    $61,665.00"]; _Pic55= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr">> "picture"); lbSetPicture    [1575, 54   , _Pic55  ];  lbSetPictureColor   [1575, 54,[0.738,0.714,0.417,1 ]];
_index55 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 2-х Дверный полукрытый, АГУ      Цена:    $63,665.00"]; _Pic56= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr_halftop">> "picture");    lbSetPicture    [1575, 55   , _Pic56  ];  lbSetPictureColor   [1575, 55,[0.738,0.714,0.417,1 ]];
_index56 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 2-х Дверный полукрытый, АГУ  Цена:    $63,665.00"]; _Pic57= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr_halftop">> "picture");    lbSetPicture    [1575, 56   , _Pic57  ];  lbSetPictureColor   [1575, 56,[0.738,0.714,0.417,1 ]];
_index57 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 2-х Дверный крытый, АГУ          Цена:    $65,665.00"]; _Pic58= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr_fulltop">> "picture"); lbSetPicture    [1575, 57   , _Pic58  ];  lbSetPictureColor   [1575, 57,[0.738,0.714,0.417,1 ]];
_index58 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 2-х Дверный крытый, АГУ      Цена:    $65,665.00"]; _Pic59= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr_fulltop">> "picture");    lbSetPicture    [1575, 58   , _Pic59  ];  lbSetPictureColor   [1575, 58,[0.738,0.714,0.417,1 ]];
_index59 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 4-х Дверный открытый, АГУ        Цена:    $61,665.00"]; _Pic60= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr">> "picture");    lbSetPicture    [1575, 59   , _Pic60  ];  lbSetPictureColor   [1575, 59,[0.738,0.714,0.417,1 ]];
_index60 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 4-х Дверный открытый, АГУ    Цена:    $61,665.00"]; _Pic61= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr">> "picture"); lbSetPicture    [1575, 60   , _Pic61  ];  lbSetPictureColor   [1575, 60,[0.738,0.714,0.417,1 ]];
_index61 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 4-х Дверный полукрытый, АГУ      Цена:    $63,665.00"]; _Pic62= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr_halftop">> "picture");    lbSetPicture    [1575, 61   , _Pic62  ];  lbSetPictureColor   [1575, 61,[0.738,0.714,0.417,1 ]];
_index62 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 4-х Дверный полукрытый, АГУ  Цена:    $63,665.00"]; _Pic63= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr_halftop">> "picture");    lbSetPicture    [1575, 62   , _Pic63  ];  lbSetPictureColor   [1575, 62,[0.738,0.714,0.417,1 ]];
_index63 =lbAdd   [1575,"USA (МП США - Лес )  Хамви(Хаммер), 4-х Дверный крытый, АГУ          Цена:    $65,665.00"]; _Pic64= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr_fulltop">> "picture");    lbSetPicture    [1575, 63   , _Pic64  ];  lbSetPictureColor   [1575, 63,[0.738,0.714,0.417,1 ]];
_index64 =lbAdd   [1575,"USA (МП США - Пустыня )  Хамви(Хаммер), 4-х Дверный крытый, АГУ      Цена:    $65,665.00"]; _Pic65= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr_fulltop">> "picture");    lbSetPicture    [1575, 64   , _Pic65  ];  lbSetPictureColor   [1575, 64,[0.738,0.714,0.417,1 ]];
_index65 =lbAdd   [1575,"USA (Армия США 2010)  Лес RG-33 (Без вооружения)                     Цена:   $460,000.00"]; _Pic66= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_wd">> "picture");  lbSetPicture    [1575, 65   , _Pic66  ];  lbSetPictureColor   [1575, 65,[0.738,0.714,0.417,1 ]];
_index66 =lbAdd   [1575,"USA (Армия США 2010)  Лес  RG-33 (M2)                                Цена:   $475,000.00"]; _Pic67= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_m2_wd">> "picture");  lbSetPicture    [1575, 66   , _Pic67  ];  lbSetPictureColor   [1575, 66,[0.738,0.714,0.417,1 ]];
_index67 =lbAdd   [1575,"USA (МП США 2010)  Лес RG-33 (Без вооружения)                        Цена:   $460,000.00"]; _Pic68= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_usmc_wd">> "picture"); lbSetPicture    [1575, 67   , _Pic68  ];  lbSetPictureColor   [1575, 67,[0.738,0.714,0.417,1 ]];
_index68 =lbAdd   [1575,"USA (МП США 2010)  Лес RG-33 (M2)                                    Цена:   $475,000.00"]; _Pic69= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_m2_usmc_wd">> "picture"); lbSetPicture    [1575, 68   , _Pic69  ];  lbSetPictureColor   [1575, 68,[0.738,0.714,0.417,1 ]];
...
_index2 =   lbAdd   [1575,"РФ (ВВС Серый)  Su-25SM                                                  Price:   $11,000,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "RHS_Su25SM_vvs">> "picture");  lbSetPicture    [1575, 2    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"РФ (ВВС Камо)  Su-25SM                                                   Price:   $11,000,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "RHS_Su25SM_vvsc">> "picture"); lbSetPicture    [1575, 3    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"A-10A Тандерболт II                                                      Price:   $11,800,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "rhs_a10">> "picture"); lbSetPicture    [1575, 4    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"Геркулес C-130J                                                          Price:   $70,370,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "RHS_C130J">> "picture");   lbSetPicture    [1575, 5    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
...
UpgradesOn = 0; 
lbClear 1575;
_index0 =   lbAdd   [1575,"AH-99 Блэкфут (Боевой)                                        Price:  $35,700,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "B_Heli_Attack_01_F">> "picture");  lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index1 =   lbAdd   [1575,"UH-80 Гостхок (Транспортный)                                  Price:  $30,500,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "B_Heli_Transport_01_F">> "picture");   lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index2 =   lbAdd   [1575,"AH-9 Пауни (Поддержка)                                        Price:  $2,300,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "B_Heli_Light_01_armed_F">> "picture"); lbSetPicture    [1575, 2    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"MH-9 Хамингберд (Малый транспортный)                          Price:  $2,000,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "B_Heli_Light_01_F">> "picture");   lbSetPicture    [1575, 3    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"PO-30 Орка (Черный)  (Транспортный)                           Price:  $14,300,000.00"]; _Pic5= getText( configFile  >> "CfgVehicles">> "O_Heli_Light_02_unarmed_F">> "picture");   lbSetPicture    [1575, 4    , _Pic5   ];  lbSetPictureColor   [1575, 4 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"PO-30 Орка  (Транспортный)                                    Price:  $16,800,000.00"]; _Pic6= getText( configFile  >> "CfgVehicles">> "O_Heli_Light_02_F">> "picture");   lbSetPicture    [1575, 5    , _Pic6   ];  lbSetPictureColor   [1575, 5,[0.738,0.714,0.417,1 ]];
_index6 =   lbAdd   [1575,"Ми-48 Кайман (Боевой, транспортный)                           Price:  $21,300,000.00"]; _Pic7= getText( configFile  >> "CfgVehicles">> "O_Heli_Attack_02_F">> "picture");  lbSetPicture    [1575, 6    , _Pic7   ];  lbSetPictureColor   [1575, 6 ,[0.738,0.714,0.417,1 ]];
_index7 =   lbAdd   [1575,"Ми-48 Кайман (Черный)  (Боевой, транспортный)                 Price:  $23,000,000.00"]; _Pic8= getText( configFile  >> "CfgVehicles">> "O_Heli_Attack_02_black_F">> "picture");    lbSetPicture    [1575, 7    , _Pic8   ];  lbSetPictureColor   [1575, 7 ,[0.738,0.714,0.417,1 ]];

if (RHS_Support_Enabled == 1) then {
_index8=lbAdd	[1500,	"США (Пустыня)  AH-1Z (Универсальный) 									Price: 	$27,550,000.00	"	];		_Pic1	=	getText	(	configFile >>	"CfgVehicles"	>>	"RHS_AH1Z">>	"picture");	lbSetPicture	[	1500	,	8	,	_Pic1	];	lbSetColor	[	1500	,	8	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index9=lbAdd	[1500,	"США (Пустыня)  AH-1Z (Поддержка)									Price: 	$27,150,000.00	"];		_Pic2	=	getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_GS">>	"picture");	lbSetPicture	[	1500	,	9	,	_Pic2	];	lbSetColor	[	1500	,	9	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index10=lbAdd	[1500,	"США (Пустыня)  AH-1Z (Штурмовик) 									Price: 	$27,350,000.00	"];		_Pic3=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_CS">>	"picture");	lbSetPicture	[	1500	,	10	,	_Pic3	];	lbSetColor	[	1500	,	10	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index11=lbAdd	[1500,	"США (Лес)  AH-1Z (Универсальный) 									Price: 	$31,550,000.00	"];		_Pic4=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd">>	"picture");	lbSetPicture	[	1500	,	11	,	_Pic4	];	lbSetColor	[	1500	,	11	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index12=lbAdd	[1500,	"США (Лес)  AH-1Z (Поддержка)										Price: 	$31,150,000.00	"];		_Pic5=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_gs">>	"picture");	lbSetPicture	[	1500	,	12	,	_Pic5	];	lbSetColor	[	1500	,	12	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index13=lbAdd	[1500,	"США (Лес)  AH-1Z (Штурмовик)										Price: 	$31,350,000.00	"];		_Pic6=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_cs">>	"picture");	lbSetPicture	[	1500	,	13	,	_Pic6	];	lbSetColor	[	1500	,	13	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index14=lbAdd	[1500,	"США (Армия США 2010)  AH-64D (Серый) 									Price: 	$65,325,950.00	"];		_Pic7=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64DGrey">>	"picture");	lbSetPicture	[	1500	,	14	,	_Pic7	];	lbSetPictureColor	[	1500	,	14	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index15=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Универсальный) 								Price: 	$35,950,000.00	"];		_Pic8=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd">>	"picture");	lbSetPicture	[	1500	,	15	,	_Pic8	];	lbSetPictureColor	[	1500	,	15	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index16=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Поддержка)								Price: 	$35,725,950.00	"];		_Pic9=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_gs">>	"picture");	lbSetPicture	[	1500	,	16	,	_Pic9	];	lbSetPictureColor	[	1500	,	16	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index17=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Штурмовик) 					                 	Price: 	$35,695,500.00	"];		_Pic10=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_cs">>	"picture");	lbSetPicture	[	1500	,	17	,	_Pic10	];	lbSetPictureColor	[	1500	,	17	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index18=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Истребитель) 								Price: 	$35,725,950.00	"];		_Pic11=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64D_wd_AA">>	"picture");	lbSetPicture	[	1500	,	18	,	_Pic11	];	lbSetPictureColor	[	1500	,	18	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index19=lbAdd	[1500,	"США (Армия США 2010)  CH-47 										Price: 	$38,550,000.00	"];		_Pic12=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_10">>	"picture");	lbSetPicture	[	1500	,	19	,	_Pic12	];	lbSetPictureColor	[	1500	,	19	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index20=lbAdd	[1500,	"США (Армия США 2010)  CH-47 (D)									Price: 	$38,550,000.00	"];		_Pic13=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light_10">>	"picture");	lbSetPicture	[	1500	,	20	,	_Pic13	];	lbSetPictureColor	[	1500	,	20	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index21=lbAdd	[1500,	"США (Арми 2014)  CH-47											Price: 	$38,550,000.00	"];		_Pic14=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f">>	"picture");	lbSetPicture	[	1500	,	21	,	_Pic14	];	lbSetPictureColor	[	1500	,	21	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index22=lbAdd	[1500,	"США (Армия США 2014)  CH-47 (D)									Price: 	$38,550,000.00	"];		_Pic15=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light">>	"picture");	lbSetPicture	[	1500	,	22	,	_Pic15	];	lbSetPictureColor	[	1500	,	22	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index23=lbAdd	[1500,	"США (МП США 2010)  UH-1Y (Ракеты/М2)									Price: 	$21,600,000.00	"];		_Pic16=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y">>	"picture");	lbSetPicture	[	1500	,	23	,	_Pic16	];	lbSetPictureColor	[	1500	,	23	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index24=lbAdd	[1500,	"США (МП США 2010)  UH-1Y (Ракеты) 									Price: 	$21,600,000.00	"];		_Pic17=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_ffar">>	"picture");	lbSetPicture	[	1500	,	24	,	_Pic17	];	lbSetPictureColor	[	1500	,	24	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index25=lbAdd	[1500,	"США (МП США 2010)  UH-1Y (Без вооружения) 								Price: 	$21,600,000.00	"];		_Pic18=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_unarmed">>	"picture");	lbSetPicture	[	1500	,	25	,	_Pic18	];	lbSetPictureColor	[	1500	,	25	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index26=lbAdd	[1500,	"США (Армия США 2014)  UH-60M 			     						        Price: 	$21,300,000.00	"];		_Pic19=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m">>	"picture");	lbSetPicture	[	1500	,	26	,	_Pic19	];	lbSetPictureColor	[	1500	,	26	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index27=lbAdd	[1500,	"США (Армия США 2014)  UH-60M Медецинский 								Price: 	$21,300,000.00	"];		_Pic20=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev2">>	"picture");	lbSetPicture	[	1500	,	27	,	_Pic20	];	lbSetPictureColor	[	1500	,	27	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index28=lbAdd	[1500,	"США (Армия США 2014)  UH-60M Медецинский (Топливные баки)						Price: 	$21,300,000.00	"];		_Pic21=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev">>	"picture");	lbSetPicture	[	1500	,	28	,	_Pic21	];	lbSetPictureColor	[	1500	,	28	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index29 =lbAdd   [1575, "РФ Ka-52 (Серый)                                           Price:   $16,000,000"];     _Pic22= getText( configFile  >> "CfgVehicles">> "RHS_Ka52_vvs">>   "picture"); lbSetPicture    [1575, 29   , _Pic22  ];  lbSetPictureColor   [1575, 29,[0.738,0.714,0.417,1 ]];
_index30 =lbAdd   [1575, "РФ Ka-52 (Камо)                                            Price:   $16,000,000"];     _Pic23= getText( configFile  >> "CfgVehicles">> "RHS_Ka52_vvsc">>  "picture"); lbSetPicture    [1575, 30   , _Pic23  ];  lbSetPictureColor   [1575, 30,[0.738,0.714,0.417,1 ]];
_index31 =lbAdd   [1575, "РФ Ka-60 (Серый)                                           Price:   $21,500,000"];     _Pic24= getText( configFile  >> "CfgVehicles">> "rhs_ka60_grey">>  "picture"); lbSetPicture    [1575, 31   , _Pic24  ];  lbSetPictureColor   [1575, 31,[0.738,0.714,0.417,1 ]];
_index32 =lbAdd   [1575, "РФ Ka-60 (Камо)                                            Price:   $21,500,000"];     _Pic25= getText( configFile  >> "CfgVehicles">> "rhs_ka60_c">> "picture"); lbSetPicture    [1575, 32   , _Pic25  ];  lbSetPictureColor   [1575, 32,[0.738,0.714,0.417,1 ]];
_index33 =lbAdd   [1575, "РФ Mи-24П                                                  Price:   $12,000,000"];     _Pic26= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vdv">>  "picture"); lbSetPicture    [1575, 33   , _Pic26  ];  lbSetPictureColor   [1575, 33,[0.738,0.714,0.417,1 ]];
_index34 =lbAdd   [1575, "РФ Mи-24В                                                  Price:   $12,000,000"];     _Pic27= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vdv">>  "picture"); lbSetPicture    [1575, 34   , _Pic27  ];  lbSetPictureColor   [1575, 34,[0.738,0.714,0.417,1 ]];
_index35 =lbAdd   [1575, "РФ Mи-24П (Серый)                                          Price:   $12,000,000"];     _Pic28= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vvs">>  "picture"); lbSetPicture    [1575, 35   , _Pic28  ];  lbSetPictureColor   [1575, 35,[0.738,0.714,0.417,1 ]];
_index36 =lbAdd   [1575, "РФ Mи-24В (Серый)                                          Price:   $12,000,000"];     _Pic29= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vvs">>  "picture"); lbSetPicture    [1575, 36   , _Pic29  ];  lbSetPictureColor   [1575, 36,[0.738,0.714,0.417,1 ]];
_index37 =lbAdd   [1575, "РФ Mи-24П (Камо)                                           Price:   $12,000,000"];     _Pic30= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vvsc">> "picture"); lbSetPicture    [1575, 37   , _Pic30  ];  lbSetPictureColor   [1575, 37,[0.738,0.714,0.417,1 ]];
_index38 =lbAdd   [1575, "РФ Mи-24В (Камо)                                           Price:   $12,000,000"];     _Pic31= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vvsc">> "picture"); lbSetPicture    [1575, 38   , _Pic31  ];  lbSetPictureColor   [1575, 38,[0.738,0.714,0.417,1 ]];
_index39 =lbAdd   [1575, "РФ Mи-8AMT                                                 Price:   $9,000,000 "];     _Pic32= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vdv">> "picture"); lbSetPicture    [1575, 39   , _Pic32  ];  lbSetPictureColor   [1575, 39,[0.738,0.714,0.417,1 ]];
_index40 =lbAdd   [1575, "РФ Mи-8AMTШ                                                Price:   $9,350,000 "];     _Pic33= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vdv">>   "picture"); lbSetPicture    [1575, 40   , _Pic33  ];  lbSetPictureColor   [1575, 40,[0.738,0.714,0.417,1 ]];
_index41 =lbAdd   [1575, "РФ Mи-8AMT (Серый)                                         Price:   $9,000,000 "];     _Pic34= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vvs">> "picture"); lbSetPicture    [1575, 41   , _Pic34  ];  lbSetPictureColor   [1575, 41,[0.738,0.714,0.417,1 ]];
_index42 =lbAdd   [1575, "РФ Mи-8AMTШ (Серый)                                        Price:   $9,350,000 "];     _Pic35= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vvs">>   "picture"); lbSetPicture    [1575, 42   , _Pic35  ];  lbSetPictureColor   [1575, 42,[0.738,0.714,0.417,1 ]];
_index43 =lbAdd   [1575, "РФ Mи-8AMT (Камо)                                          Price:   $9,000,000 "];     _Pic36= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vvsc">> "picture"); lbSetPicture    [1575, 43   , _Pic36  ];  lbSetPictureColor   [1575, 43,[0.738,0.714,0.417,1 ]];
_index44 =lbAdd   [1575, "РФ Mи-8AMTШ (Камо)                                         Price:   $9,350,000 "];     _Pic37= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vvsc">>  "picture"); lbSetPicture    [1575, 44   , _Pic37  ];  lbSetPictureColor   [1575, 44,[0.738,0.714,0.417,1 ]];
_index45 =lbAdd   [1575, "РФ Mи-8MT                                                  Price:   $9,000,000 "];     _Pic38= getText( configFile  >> "CfgVehicles">> "RHS_Mi8mt_vdv">>  "picture"); lbSetPicture    [1575, 45   , _Pic38  ];  lbSetPictureColor   [1575, 45,[0.738,0.714,0.417,1 ]];
_index46 =lbAdd   [1575, "РФ Mи-8МТВ-3                                               Price:   $9,350,000 "];     _Pic39= getText( configFile  >> "CfgVehicles">> "RHS_Mi8MTV3_vdv">> "picture"); lbSetPicture    [1575, 46   , _Pic39  ];  lbSetPictureColor   [1575, 46,[0.738,0.714,0.417,1 ]];
