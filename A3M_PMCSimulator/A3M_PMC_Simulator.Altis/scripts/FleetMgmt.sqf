...
RHS_AH1Z= 27550000;
RHS_AH1Z_GS= 27150000;
RHS_AH1Z_CS= 27350000;
rhs_ah1z_wd = 31550000;
rhs_ah1z_wd_gs= 31150000;
...
UpgradesOn = 0; 
lbClear 1575;
_index0 =   lbAdd   [1575,"MAT-V Без вооружения                                                     Цена:   $470,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "B_MRAP_01_F">> "picture"); lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index1 =   lbAdd   [1575,"MAT-V (.50 Пулемет)                                                      Цена:   $500,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "B_MRAP_01_hmg_F">> "picture"); lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index2 =   lbAdd   [1575,"MAT-V (40mm Гранатомет)                                                  Цена:   $520,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "B_MRAP_01_gmg_F">> "picture"); lbSetPicture    [1575, 2    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"HEMTT Десантный - Закрытый кузов                                         Цена:   $125,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "B_Truck_01_covered_F">> "picture");    lbSetPicture    [1575, 3    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"HEMTT Десантный - Открытый кузов                                         Цена:    $90,000.00"]; _Pic5= getText( configFile  >> "CfgVehicles">> "B_Truck_01_transport_F">> "picture");  lbSetPicture    [1575, 4    , _Pic5   ];  lbSetPictureColor   [1575, 4 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"Квадроцикл                                                               Цена:     $7,500.00"]; _Pic6= getText( configFile  >> "CfgVehicles">> "B_Quadbike_01_F">> "picture"); lbSetPicture    [1575, 5    , _Pic6   ];  lbSetPictureColor   [1575, 5,[0.738,0.714,0.417,1 ]];
_index6 =   lbAdd   [1575,"Ifrit Без вооружения                                                     Цена:   $470,000.00"]; _Pic7= getText( configFile  >> "CfgVehicles">> "O_MRAP_02_F">> "picture"); lbSetPicture    [1575, 6    , _Pic7   ];  lbSetPictureColor   [1575, 6 ,[0.738,0.714,0.417,1 ]];
_index7 =   lbAdd   [1575,"Ifrit (.50 Пулемет)                                                      Цена:   $500,000.00"]; _Pic8= getText( configFile  >> "CfgVehicles">> "O_MRAP_02_hmg_F">> "picture"); lbSetPicture    [1575, 7    , _Pic8   ];  lbSetPictureColor   [1575, 7 ,[0.738,0.714,0.417,1 ]];
_index8 =   lbAdd   [1575,"Ifrit (40mm Гранатомет)                                                  Цена:   $520,000.00"]; _Pic9= getText( configFile  >> "CfgVehicles">> "O_MRAP_02_gmg_F">> "picture"); lbSetPicture    [1575, 8    , _Pic9   ];  lbSetPictureColor   [1575, 8 ,[0.738,0.714,0.417,1 ]];
_index9 =   lbAdd   [1575,"Zamak Десантный - Закрытый кузов                                         Цена:   $125,000.00"]; _Pic10= getText( configFile  >> "CfgVehicles">> "O_Truck_02_covered_F">> "picture");    lbSetPicture    [1575, 9    , _Pic10  ];  lbSetPictureColor   [1575, 9 ,[0.738,0.714,0.417,1 ]];
_index10 =  lbAdd   [1575,"Zamak Десантный - Открытый кузов                                         Цена:    $90,000.00"]; _Pic11= getText( configFile  >> "CfgVehicles">> "O_Truck_02_transport_F">> "picture");  lbSetPicture    [1575, 10   , _Pic11  ];  lbSetPictureColor   [1575, 10,[0.738,0.714,0.417,1 ]];

if (RHS_Support_Enabled == 1) then {

_index11 =lbAdd   [1575,"ГАЗ 233011 Тигр                                                      Цена:    $75,500.00"]; _Pic12= getText( configFile  >> "CfgVehicles">> "rhs_tigr_msv">> "picture");   lbSetPicture    [1575, 11   , _Pic12  ];  lbSetPictureColor   [1575, 11,[0.738,0.714,0.417,1 ]];
_index12 =lbAdd   [1575,"ГАЗ-66                                                               Цена:   $125,500.00"]; _Pic13= getText( configFile  >> "CfgVehicles">> "rhs_gaz66_msv">> "picture");  lbSetPicture    [1575, 12   , _Pic13  ];  lbSetPictureColor   [1575, 12,[0.738,0.714,0.417,1 ]];
_index13 =lbAdd   [1575,"ГАЗ-66 (Открытый)                                                    Цена:   $125,500.00"]; _Pic14= getText( configFile  >> "CfgVehicles">> "rhs_gaz66o_msv">> "picture"); lbSetPicture    [1575, 13   , _Pic14  ];  lbSetPictureColor   [1575, 13,[0.738,0.714,0.417,1 ]];
_index14 =lbAdd   [1575,"ГАЗ-66 (Р-142Н, Радиостанция)                                        Цена:   $125,500.00"]; _Pic15= getText( configFile  >> "CfgVehicles">> "rhs_gaz66_r142_msv">> "picture");  lbSetPicture    [1575, 14   , _Pic15  ];  lbSetPictureColor   [1575, 14,[0.738,0.714,0.417,1 ]];
_index15 =lbAdd   [1575,"ГАЗ-66 (АП-2, Медецинский)                                           Цена:   $125,500.00"]; _Pic16= getText( configFile  >> "CfgVehicles">> "rhs_gaz66_ap2_msv">> "picture");  lbSetPicture    [1575, 15   , _Pic16  ];  lbSetPictureColor   [1575, 15,[0.738,0.714,0.417,1 ]];
_index16 =lbAdd   [1575,"ГАЗ-66 (ЭСБ-8ИМ, Ремонтный)                                          Цена:   $125,500.00"]; _Pic17= getText( configFile  >> "CfgVehicles">> "rhs_gaz66_repair_msv">> "picture");    lbSetPicture    [1575, 16   , _Pic17  ];  lbSetPictureColor   [1575, 16,[0.738,0.714,0.417,1 ]];
_index17 =lbAdd   [1575,"КамАЗ-63968                                                          Цена:    $75,000.00"]; _Pic18= getText( configFile  >> "CfgVehicles">> "rhs_typhoon_vdv">> "picture"); lbSetPicture    [1575, 17   , _Pic18  ];  lbSetPictureColor   [1575, 17,[0.738,0.714,0.417,1 ]];
_index18 =lbAdd   [1575,"УАЗ-469                                                              Цена:    $15,500.00"]; _Pic19= getText( configFile  >> "CfgVehicles">> "rhs_uaz_vdv">> "picture"); lbSetPicture    [1575, 18   , _Pic19  ];  lbSetPictureColor   [1575, 18,[0.738,0.714,0.417,1 ]];
_index19 =lbAdd   [1575,"Урал-4320                                                            Цена:    $73,500.00"]; _Pic20= getText( configFile  >> "CfgVehicles">> "rhs_ural_msv">> "picture");    lbSetPicture    [1575, 19   , _Pic20  ];  lbSetPictureColor   [1575, 19,[0.738,0.714,0.417,1 ]];
_index20 =lbAdd   [1575,"Урал-4320 (Открытый)                                                 Цена:    $78,000.00"]; _Pic21= getText( configFile  >> "CfgVehicles">> "rhs_ural_open_msv">> "picture");   lbSetPicture    [1575, 20   , _Pic21  ];  lbSetPictureColor   [1575, 20,[0.738,0.714,0.417,1 ]];
_index21 =lbAdd   [1575,"США (Армия США - Лес ) HMMWV (Без вооружения)                        Цена:    $74,969.00"]; _Pic22= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w">> "picture");  lbSetPicture    [1575, 21   , _Pic22  ];  lbSetPictureColor   [1575, 21,[0.738,0.714,0.417,1 ]];
_index22 =lbAdd   [1575,"США (Армия США - Пустыня ) HMMWV (Без вооружения)                    Цена:    $74,969.00"]; _Pic23= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d">> "picture");  lbSetPicture    [1575, 22   , _Pic23  ];  lbSetPictureColor   [1575, 22,[0.738,0.714,0.417,1 ]];
_index23 =lbAdd   [1575,"США (КМП США - Лес ) HMMWV (Без вооружения/АГУ)                      Цена:    $75,969.00"]; _Pic24= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s">> "picture");   lbSetPicture    [1575, 23   , _Pic24  ];  lbSetPictureColor   [1575, 23,[0.738,0.714,0.417,1 ]];
_index24 =lbAdd   [1575,"США (КМП США - Пустыня ) HMMWV (Без вооружения/АГУ)                  Цена:    $75,969.00"]; _Pic25= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s">> "picture");   lbSetPicture    [1575, 24   , _Pic25  ];  lbSetPictureColor   [1575, 24,[0.738,0.714,0.417,1 ]];
_index25 =lbAdd   [1575,"США (Армия США - Лес ) HMMWV (M2)                                    Цена:    $84,969.00"]; _Pic26= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_m2">> "picture");   lbSetPicture    [1575, 25   , _Pic26  ];  lbSetPictureColor   [1575, 25,[0.738,0.714,0.417,1 ]];
_index26 =lbAdd   [1575,"США (Армия США - Пустыня ) HMMWV (M2)                                Цена:    $84,969.00"]; _Pic27= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d_m2">> "picture");  lbSetPicture    [1575, 26   , _Pic27  ];  lbSetPictureColor   [1575, 26,[0.738,0.714,0.417,1 ]];
_index27 =lbAdd   [1575,"США (КМП США - Лес ) HMMWV (M2/АГУ)                                  Цена:    $85,969.00"]; _Pic28= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_w_s_m2">> "picture");    lbSetPicture    [1575, 27   , _Pic28  ];  lbSetPictureColor   [1575, 27,[0.738,0.714,0.417,1 ]];
_index28 =lbAdd   [1575,"США (КМП США - Пустыня ) HMMWV (M2/АГУ)                              Цена:    $85,969.00"]; _Pic29= getText( configFile  >> "CfgVehicles">> "rhsusf_m1025_d_s_m2">> "picture");    lbSetPicture    [1575, 28   , _Pic29  ];  lbSetPictureColor   [1575, 28,[0.738,0.714,0.417,1 ]];
_index29 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2                                      Цена:   $200,000.00"]; _Pic30= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 29   , _Pic30  ];  lbSetPictureColor   [1575, 29,[0.738,0.714,0.417,1 ]];
_index30 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2 (Открытый)                           Цена:   $200,000.00"]; _Pic31= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_open_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 30   , _Pic31  ];  lbSetPictureColor   [1575, 30,[0.738,0.714,0.417,1 ]];
_index31 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2 (Открытый без тентовой основы)       Цена:   $200,000.00"]; _Pic32= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 31   , _Pic32  ];  lbSetPictureColor   [1575, 31,[0.738,0.714,0.417,1 ]];
_index32 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B                                    Цена:   $200,500.00"]; _Pic33= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 32   , _Pic33  ];  lbSetPictureColor   [1575, 32,[0.738,0.714,0.417,1 ]];
_index33 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B (Открытый)                         Цена:   $200,500.00"]; _Pic34= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_open_fmtv_usarmy">> "picture");  lbSetPicture    [1575, 33   , _Pic34  ];  lbSetPictureColor   [1575, 33,[0.738,0.714,0.417,1 ]];
_index34 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B (Открытый без тентовой основы)     Цена:   $200,500.00"]; _Pic35= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_wd_flatbed_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 34   , _Pic35  ];  lbSetPictureColor   [1575, 34,[0.738,0.714,0.417,1 ]];
_index35 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B (M2)                               Цена:   $210,000.00"]; _Pic36= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_fmtv_usarmy">> "picture");    lbSetPicture    [1575, 35   , _Pic36  ];  lbSetPictureColor   [1575, 35,[0.738,0.714,0.417,1 ]];
_index36 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B (M2/Открытый)                      Цена:   $210,000.00"]; _Pic37= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_open_fmtv_usarmy">> "picture");  lbSetPicture    [1575, 36   , _Pic37  ];  lbSetPictureColor   [1575, 36,[0.738,0.714,0.417,1 ]];
_index37 =lbAdd   [1575,"США (Армия США 2014)  M1078A1P2-B (M2/Открытый без тентовой основы)  Цена:   $210,000.00"]; _Pic38= getText( configFile  >> "CfgVehicles">> "rhsusf_M1078A1P2_B_M2_wd_flatbed_fmtv_usarmy">> "picture");   lbSetPicture    [1575, 37   , _Pic38  ];  lbSetPictureColor   [1575, 37,[0.738,0.714,0.417,1 ]];
_index38 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2                                      Цена:   $200,000.00"]; _Pic39= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 38   , _Pic39  ];  lbSetPictureColor   [1575, 38,[0.738,0.714,0.417,1 ]];
_index39 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2 (Открытый)                           Цена:   $200,000.00"]; _Pic40= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_open_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 39   , _Pic40  ];  lbSetPictureColor   [1575, 39,[0.738,0.714,0.417,1 ]];
_index40 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2 (Открытый без тентовой основы)       Цена:   $200,000.00"]; _Pic41= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 40   , _Pic41  ];  lbSetPictureColor   [1575, 40,[0.738,0.714,0.417,1 ]];
_index41 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B                                    Цена:   $200,500.00"]; _Pic42= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 41   , _Pic42  ];  lbSetPictureColor   [1575, 41,[0.738,0.714,0.417,1 ]];
_index42 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B (Открытый)                         Цена:   $200,500.00"]; _Pic43= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_open_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 42   , _Pic43  ];  lbSetPictureColor   [1575, 42,[0.738,0.714,0.417,1 ]];
_index43 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B (Открытый без тентовой основы)     Цена:   $200,500.00"]; _Pic44= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy_10">> "picture");   lbSetPicture    [1575, 43   , _Pic44  ];  lbSetPictureColor   [1575, 43,[0.738,0.714,0.417,1 ]];
_index44 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B (M2)                               Цена:   $210,000.00"]; _Pic45= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_fmtv_usarmy_10">> "picture"); lbSetPicture    [1575, 44   , _Pic45  ];  lbSetPictureColor   [1575, 44,[0.738,0.714,0.417,1 ]];
_index45 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B (M2/Открытый)                      Цена:   $210,000.00"]; _Pic46= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_open_fmtv_usarmy_10">> "picture");    lbSetPicture    [1575, 45   , _Pic46  ];  lbSetPictureColor   [1575, 45,[0.738,0.714,0.417,1 ]];
_index46 =lbAdd   [1575,"США (Армия США 2010)  M1083A1P2-B (M2/Открытый без тентовой основы)  Цена:   $210,000.00"]; _Pic47= getText( configFile  >> "CfgVehicles">> "rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy_10">> "picture");    lbSetPicture    [1575, 46   , _Pic47  ];  lbSetPictureColor   [1575, 46,[0.738,0.714,0.417,1 ]];
_index47 =lbAdd   [1575,"США (Армия США - Лес )  HMMWV , 2-х Дверный открытый                 Цена:    $61,665.00"]; _Pic48= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr">> "picture");  lbSetPicture    [1575, 47   , _Pic48  ];  lbSetPictureColor   [1575, 47,[0.738,0.714,0.417,1 ]];
_index48 =lbAdd   [1575,"США (Армия США - Пустыня )  ХHMMWV , 2-х Дверный открытый            Цена:    $61,665.00"]; _Pic49= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr">> "picture");   lbSetPicture    [1575, 48   , _Pic49  ];  lbSetPictureColor   [1575, 48,[0.738,0.714,0.417,1 ]];
_index49 =lbAdd   [1575,"США (Армия США - Лес )  HMMWV , 2-х Дверный полукрытый               Цена:    $63,665.00"]; _Pic50= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr_halftop">> "picture");   lbSetPicture    [1575, 49   , _Pic50  ];  lbSetPictureColor   [1575, 49,[0.738,0.714,0.417,1 ]];
_index50 =lbAdd   [1575,"США (Армия США - Пустыня )  HMMWV , 2-х Дверный полукрытый           Цена:    $63,665.00"]; _Pic51= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr_halftop">> "picture");   lbSetPicture    [1575, 50   , _Pic51  ];  lbSetPictureColor   [1575, 50,[0.738,0.714,0.417,1 ]];
_index51 =lbAdd   [1575,"США (Армия США - Лес )  HMMWV , 2-х Дверный крытый                   Цена:    $65,665.00"]; _Pic52= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_4dr_fulltop">> "picture");   lbSetPicture    [1575, 51   , _Pic52  ];  lbSetPictureColor   [1575, 51,[0.738,0.714,0.417,1 ]];
_index52 =lbAdd   [1575,"США (Армия США - Пустыня )  HMMWV , 2-х Дверный крытый               Цена:    $65,665.00"]; _Pic53= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_4dr_fulltop">> "picture");   lbSetPicture    [1575, 52   , _Pic53  ];  lbSetPictureColor   [1575, 52,[0.738,0.714,0.417,1 ]];
_index53 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 2-х Дверный открытый, АГУ               Цена:    $61,665.00"]; _Pic54= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr">> "picture");    lbSetPicture    [1575, 53   , _Pic54  ];  lbSetPictureColor   [1575, 53,[0.738,0.714,0.417,1 ]];
_index54 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 2-х Дверный открытый, АГУ           Цена:    $61,665.00"]; _Pic55= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr">> "picture"); lbSetPicture    [1575, 54   , _Pic55  ];  lbSetPictureColor   [1575, 54,[0.738,0.714,0.417,1 ]];
_index55 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 2-х Дверный полукрытый, АГУ             Цена:    $63,665.00"]; _Pic56= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr_halftop">> "picture");    lbSetPicture    [1575, 55   , _Pic56  ];  lbSetPictureColor   [1575, 55,[0.738,0.714,0.417,1 ]];
_index56 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 2-х Дверный полукрытый, АГУ         Цена:    $63,665.00"]; _Pic57= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr_halftop">> "picture");    lbSetPicture    [1575, 56   , _Pic57  ];  lbSetPictureColor   [1575, 56,[0.738,0.714,0.417,1 ]];
_index57 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 2-х Дверный крытый, АГУ                 Цена:    $65,665.00"]; _Pic58= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_2dr_fulltop">> "picture"); lbSetPicture    [1575, 57   , _Pic58  ];  lbSetPictureColor   [1575, 57,[0.738,0.714,0.417,1 ]];
_index58 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 2-х Дверный крытый, АГУ             Цена:    $65,665.00"]; _Pic59= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_2dr_fulltop">> "picture");    lbSetPicture    [1575, 58   , _Pic59  ];  lbSetPictureColor   [1575, 58,[0.738,0.714,0.417,1 ]];
_index59 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 4-х Дверный открытый, АГУ               Цена:    $61,665.00"]; _Pic60= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr">> "picture");    lbSetPicture    [1575, 59   , _Pic60  ];  lbSetPictureColor   [1575, 59,[0.738,0.714,0.417,1 ]];
_index60 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 4-х Дверный открытый, АГУ           Цена:    $61,665.00"]; _Pic61= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr">> "picture"); lbSetPicture    [1575, 60   , _Pic61  ];  lbSetPictureColor   [1575, 60,[0.738,0.714,0.417,1 ]];
_index61 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 4-х Дверный полукрытый, АГУ             Цена:    $63,665.00"]; _Pic62= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr_halftop">> "picture");    lbSetPicture    [1575, 61   , _Pic62  ];  lbSetPictureColor   [1575, 61,[0.738,0.714,0.417,1 ]];
_index62 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 4-х Дверный полукрытый, АГУ         Цена:    $63,665.00"]; _Pic63= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr_halftop">> "picture");    lbSetPicture    [1575, 62   , _Pic63  ];  lbSetPictureColor   [1575, 62,[0.738,0.714,0.417,1 ]];
_index63 =lbAdd   [1575,"США (КМП США - Лес )  HMMWV, 4-х Дверный крытый, АГУ                 Цена:    $65,665.00"]; _Pic64= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_w_s_4dr_fulltop">> "picture");    lbSetPicture    [1575, 63   , _Pic64  ];  lbSetPictureColor   [1575, 63,[0.738,0.714,0.417,1 ]];
_index64 =lbAdd   [1575,"США (КМП США - Пустыня )  HMMWV, 4-х Дверный крытый, АГУ             Цена:    $65,665.00"]; _Pic65= getText( configFile  >> "CfgVehicles">> "rhsusf_m998_d_s_4dr_fulltop">> "picture");    lbSetPicture    [1575, 64   , _Pic65  ];  lbSetPictureColor   [1575, 64,[0.738,0.714,0.417,1 ]];
_index65 =lbAdd   [1575,"США (Армия США 2010)  Лес RG-33 (Без вооружения)                     Цена:   $460,000.00"]; _Pic66= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_wd">> "picture");  lbSetPicture    [1575, 65   , _Pic66  ];  lbSetPictureColor   [1575, 65,[0.738,0.714,0.417,1 ]];
_index66 =lbAdd   [1575,"США (Армия США 2010)  Лес  RG-33 (M2)                                Цена:   $475,000.00"]; _Pic67= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_m2_wd">> "picture");  lbSetPicture    [1575, 66   , _Pic67  ];  lbSetPictureColor   [1575, 66,[0.738,0.714,0.417,1 ]];
_index67 =lbAdd   [1575,"США (МП США 2010)  Лес RG-33 (Без вооружения)                        Цена:   $460,000.00"]; _Pic68= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_usmc_wd">> "picture"); lbSetPicture    [1575, 67   , _Pic68  ];  lbSetPictureColor   [1575, 67,[0.738,0.714,0.417,1 ]];
_index68 =lbAdd   [1575,"США (МП США 2010)  Лес RG-33 (M2)                                    Цена:   $475,000.00"]; _Pic69= getText( configFile  >> "CfgVehicles">> "rhsusf_rg33_m2_usmc_wd">> "picture"); lbSetPicture    [1575, 68   , _Pic69  ];  lbSetPictureColor   [1575, 68,[0.738,0.714,0.417,1 ]];
...
UpgradesOn = 0; 
lbClear 1575;
_index0 =   lbAdd   [1575,"A-164 (Штурмовик)                                                        Цена:   $11,800,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "B_Plane_CAS_01_F">> "picture");    lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index1 =   lbAdd   [1575,"To-199 Неофрон (Истребитель)                                             Цена:   $11,000,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "O_Plane_CAS_02_F">> "picture");    lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];

if (RHS_Support_Enabled == 1) then {

_index2 =   lbAdd   [1575,"РФ (ВВС Серый)  СУ-25СМ  (Штурмовик)                                     Цена:   $11,000,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "RHS_Su25SM_vvs">> "picture");  lbSetPicture    [1575, 2    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"РФ (ВВС Камо)  СУ-25СМ  (Штурмовик)                                      Цена:   $11,000,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "RHS_Su25SM_vvsc">> "picture"); lbSetPicture    [1575, 3    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"A-10A Тандерболт II  (Штурмовик)                                         Цена:   $11,800,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "rhs_a10">> "picture"); lbSetPicture    [1575, 4    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"Геркулес C-130J  (Транспортный)                                          Цена:   $70,370,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "RHS_C130J">> "picture");   lbSetPicture    [1575, 5    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
...
UpgradesOn = 0; 
lbClear 1575;
_index0 =   lbAdd   [1575,"AH-99 Блэкфут (Боевой)                                        Цена:  $35,700,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "B_Heli_Attack_01_F">> "picture");  lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index1 =   lbAdd   [1575,"UH-80 Гостхок (Транспортный)                                  Цена:  $30,500,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "B_Heli_Transport_01_F">> "picture");   lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index2 =   lbAdd   [1575,"AH-9 Пауни (Поддержка)                                        Цена:  $2,300,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "B_Heli_Light_01_armed_F">> "picture"); lbSetPicture    [1575, 2    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"MH-9 Хамингберд (Малый транспортный)                          Цена:  $2,000,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "B_Heli_Light_01_F">> "picture");   lbSetPicture    [1575, 3    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"PO-30 Орка (Черный)  (Транспортный)                           Цена:  $14,300,000.00"]; _Pic5= getText( configFile  >> "CfgVehicles">> "O_Heli_Light_02_unarmed_F">> "picture");   lbSetPicture    [1575, 4    , _Pic5   ];  lbSetPictureColor   [1575, 4 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"PO-30 Орка  (Транспортный)                                    Цена:  $16,800,000.00"]; _Pic6= getText( configFile  >> "CfgVehicles">> "O_Heli_Light_02_F">> "picture");   lbSetPicture    [1575, 5    , _Pic6   ];  lbSetPictureColor   [1575, 5,[0.738,0.714,0.417,1 ]];
_index6 =   lbAdd   [1575,"Ми-48 Кайман (Боевой, транспортный)                           Цена:  $21,300,000.00"]; _Pic7= getText( configFile  >> "CfgVehicles">> "O_Heli_Attack_02_F">> "picture");  lbSetPicture    [1575, 6    , _Pic7   ];  lbSetPictureColor   [1575, 6 ,[0.738,0.714,0.417,1 ]];
_index7 =   lbAdd   [1575,"Ми-48 Кайман (Черный)  (Боевой, транспортный)                 Цена:  $23,000,000.00"]; _Pic8= getText( configFile  >> "CfgVehicles">> "O_Heli_Attack_02_black_F">> "picture");    lbSetPicture    [1575, 7    , _Pic8   ];  lbSetPictureColor   [1575, 7 ,[0.738,0.714,0.417,1 ]];

if (RHS_Support_Enabled == 1) then {
_index8=lbAdd	[1500,"США (Пустыня)  AH-1Z (Универсальный) 								 Цена: 	$27,550,000.00"];		_Pic1	=	getText	(	configFile >>	"CfgVehicles"	>>	"RHS_AH1Z">>	"picture");	lbSetPicture	[	1500	,	8	,	_Pic1	];	lbSetColor	[	1500	,	8	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index9=lbAdd	[1500,	"США (Пустыня)  AH-1Z (Поддержка)								 Цена: 	$27,150,000.00"];		_Pic2	=	getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_GS">>	"picture");	lbSetPicture	[	1500	,	9	,	_Pic2	];	lbSetColor	[	1500	,	9	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index10=lbAdd	[1500,	"США (Пустыня)  AH-1Z (Штурмовик) 								 Цена: 	$27,350,000.00"];		_Pic3=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH1Z_CS">>	"picture");	lbSetPicture	[	1500	,	10	,	_Pic3	];	lbSetColor	[	1500	,	10	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index11=lbAdd	[1500,	"США (Лес)  AH-1Z (Универсальный) 								 Цена: 	$31,550,000.00"];		_Pic4=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd">>	"picture");	lbSetPicture	[	1500	,	11	,	_Pic4	];	lbSetColor	[	1500	,	11	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index12=lbAdd	[1500,	"США (Лес)  AH-1Z (Поддержка)									 Цена: 	$31,150,000.00"];		_Pic5=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_gs">>	"picture");	lbSetPicture	[	1500	,	12	,	_Pic5	];	lbSetColor	[	1500	,	12	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index13=lbAdd	[1500,	"США (Лес)  AH-1Z (Штурмовик)									 Цена: 	$31,350,000.00"];		_Pic6=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah1z_wd_cs">>	"picture");	lbSetPicture	[	1500	,	13	,	_Pic6	];	lbSetColor	[	1500	,	13	,	[	0.9	,	0.2	,	0.2	,	0.5	]];
_index14=lbAdd	[1500,	"США (Армия США 2010)  AH-64D (Серый) 								 Цена: 	$65,325,950.00"];		_Pic7=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64DGrey">>	"picture");	lbSetPicture	[	1500	,	14	,	_Pic7	];	lbSetPictureColor	[	1500	,	14	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index15=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Универсальный) 							 Цена: 	$35,950,000.00"];		_Pic8=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd">>	"picture");	lbSetPicture	[	1500	,	15	,	_Pic8	];	lbSetPictureColor	[	1500	,	15	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index16=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Поддержка)							 Цена: 	$35,725,950.00"];		_Pic9=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_gs">>	"picture");	lbSetPicture	[	1500	,	16	,	_Pic9	];	lbSetPictureColor	[	1500	,	16	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index17=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Штурмовик) 					               	 Цена: 	$35,695,500.00"];		_Pic10=getText	(	configFile >>	"CfgVehicles">>	"rhs_ah64d_wd_cs">>	"picture");	lbSetPicture	[	1500	,	17	,	_Pic10	];	lbSetPictureColor	[	1500	,	17	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index18=lbAdd	[1500,	"США (Армия США 2014)  AH-64D (Истребитель) 							 Цена: 	$35,725,950.00"];		_Pic11=getText	(	configFile >>	"CfgVehicles">>	"RHS_AH64D_wd_AA">>	"picture");	lbSetPicture	[	1500	,	18	,	_Pic11	];	lbSetPictureColor	[	1500	,	18	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index19=lbAdd	[1500,	"США (Армия США 2010)  CH-47 									 Цена: 	$38,550,000.00"];		_Pic12=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_10">>	"picture");	lbSetPicture	[	1500	,	19	,	_Pic12	];	lbSetPictureColor	[	1500	,	19	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index20=lbAdd	[1500,	"США (Армия США 2010)  CH-47 (D)								 Цена: 	$38,550,000.00"];		_Pic13=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light_10">>	"picture");	lbSetPicture	[	1500	,	20	,	_Pic13	];	lbSetPictureColor	[	1500	,	20	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index21=lbAdd	[1500,	"США (Арми 2014)  CH-47										 Цена: 	$38,550,000.00"];		_Pic14=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f">>	"picture");	lbSetPicture	[	1500	,	21	,	_Pic14	];	lbSetPictureColor	[	1500	,	21	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index22=lbAdd	[1500,	"США (Армия США 2014)  CH-47 (D)								 Цена: 	$38,550,000.00"];		_Pic15=getText	(	configFile >>	"CfgVehicles">>	"rhs_ch_47f_light">>	"picture");	lbSetPicture	[	1500	,	22	,	_Pic15	];	lbSetPictureColor	[	1500	,	22	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index23=lbAdd	[1500,	"США (КМП США 2010)  UH-1Y (Ракеты/М2)								 Цена: 	$21,600,000.00"];		_Pic16=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y">>	"picture");	lbSetPicture	[	1500	,	23	,	_Pic16	];	lbSetPictureColor	[	1500	,	23	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index24=lbAdd	[1500,	"США (КМП США 2010)  UH-1Y (Ракеты) 								 Цена: 	$21,600,000.00"];		_Pic17=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_ffar">>	"picture");	lbSetPicture	[	1500	,	24	,	_Pic17	];	lbSetPictureColor	[	1500	,	24	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index25=lbAdd	[1500,	"США (КМП США 2010)  UH-1Y (Без вооружения) 							 Цена: 	$21,600,000.00"];		_Pic18=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh1y_unarmed">>	"picture");	lbSetPicture	[	1500	,	25	,	_Pic18	];	lbSetPictureColor	[	1500	,	25	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index26=lbAdd	[1500,	"США (Армия США 2014)  UH-60M 			     					         Цена: 	$21,300,000.00"];		_Pic19=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m">>	"picture");	lbSetPicture	[	1500	,	26	,	_Pic19	];	lbSetPictureColor	[	1500	,	26	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index27=lbAdd	[1500,	"США (Армия США 2014)  UH-60M Медецинский 							 Цена: 	$21,300,000.00"];		_Pic20=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev2">>	"picture");	lbSetPicture	[	1500	,	27	,	_Pic20	];	lbSetPictureColor	[	1500	,	27	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index28=lbAdd	[1500,	"США (Армия США 2014)  UH-60M Медецинский (Топливные баки)					 Цена: 	$21,300,000.00"];		_Pic21=getText	(	configFile >>	"CfgVehicles">>	"rhs_uh60m_mev">>	"picture");	lbSetPicture	[	1500	,	28	,	_Pic21	];	lbSetPictureColor	[	1500	,	28	,	[	0.9	,	0.9	,	0.9	,	0.8	]];
_index29 =lbAdd   [1575, "РФ Ka-52 (Серый)                                           					 Цена:   $16,000,000"];     _Pic22= getText( configFile  >> "CfgVehicles">> "RHS_Ka52_vvs">>   "picture"); lbSetPicture    [1575, 29   , _Pic22  ];  lbSetPictureColor   [1575, 29,[0.738,0.714,0.417,1 ]];
_index30 =lbAdd   [1575, "РФ Ka-52 (Камо)                                            					 Цена:   $16,000,000"];     _Pic23= getText( configFile  >> "CfgVehicles">> "RHS_Ka52_vvsc">>  "picture"); lbSetPicture    [1575, 30   , _Pic23  ];  lbSetPictureColor   [1575, 30,[0.738,0.714,0.417,1 ]];
_index31 =lbAdd   [1575, "РФ Ka-60 (Серый)                                           					 Цена:   $21,500,000"];     _Pic24= getText( configFile  >> "CfgVehicles">> "rhs_ka60_grey">>  "picture"); lbSetPicture    [1575, 31   , _Pic24  ];  lbSetPictureColor   [1575, 31,[0.738,0.714,0.417,1 ]];
_index32 =lbAdd   [1575, "РФ Ka-60 (Камо)                                            					 Цена:   $21,500,000"];     _Pic25= getText( configFile  >> "CfgVehicles">> "rhs_ka60_c">> "picture"); lbSetPicture    [1575, 32   , _Pic25  ];  lbSetPictureColor   [1575, 32,[0.738,0.714,0.417,1 ]];
_index33 =lbAdd   [1575, "РФ Mи-24П                                                  					 Цена:   $12,000,000"];     _Pic26= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vdv">>  "picture"); lbSetPicture    [1575, 33   , _Pic26  ];  lbSetPictureColor   [1575, 33,[0.738,0.714,0.417,1 ]];
_index34 =lbAdd   [1575, "РФ Mи-24В                                                  					 Цена:   $12,000,000"];     _Pic27= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vdv">>  "picture"); lbSetPicture    [1575, 34   , _Pic27  ];  lbSetPictureColor   [1575, 34,[0.738,0.714,0.417,1 ]];
_index35 =lbAdd   [1575, "РФ Mи-24П (Серый)                                          					 Цена:   $12,000,000"];     _Pic28= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vvs">>  "picture"); lbSetPicture    [1575, 35   , _Pic28  ];  lbSetPictureColor   [1575, 35,[0.738,0.714,0.417,1 ]];
_index36 =lbAdd   [1575, "РФ Mи-24В (Серый)                                          					 Цена:   $12,000,000"];     _Pic29= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vvs">>  "picture"); lbSetPicture    [1575, 36   , _Pic29  ];  lbSetPictureColor   [1575, 36,[0.738,0.714,0.417,1 ]];
_index37 =lbAdd   [1575, "РФ Mи-24П (Камо)                                           					 Цена:   $12,000,000"];     _Pic30= getText( configFile  >> "CfgVehicles">> "RHS_Mi24P_vvsc">> "picture"); lbSetPicture    [1575, 37   , _Pic30  ];  lbSetPictureColor   [1575, 37,[0.738,0.714,0.417,1 ]];
_index38 =lbAdd   [1575, "РФ Mи-24В (Камо)                                           					 Цена:   $12,000,000"];     _Pic31= getText( configFile  >> "CfgVehicles">> "RHS_Mi24V_vvsc">> "picture"); lbSetPicture    [1575, 38   , _Pic31  ];  lbSetPictureColor   [1575, 38,[0.738,0.714,0.417,1 ]];
_index39 =lbAdd   [1575, "РФ Mи-8AMT                                                 					 Цена:   $9,000,000 "];     _Pic32= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vdv">> "picture"); lbSetPicture    [1575, 39   , _Pic32  ];  lbSetPictureColor   [1575, 39,[0.738,0.714,0.417,1 ]];
_index40 =lbAdd   [1575, "РФ Mи-8AMTШ                                                					 Цена:   $9,350,000 "];     _Pic33= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vdv">>   "picture"); lbSetPicture    [1575, 40   , _Pic33  ];  lbSetPictureColor   [1575, 40,[0.738,0.714,0.417,1 ]];
_index41 =lbAdd   [1575, "РФ Mи-8AMT (Серый)                                         					 Цена:   $9,000,000 "];     _Pic34= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vvs">> "picture"); lbSetPicture    [1575, 41   , _Pic34  ];  lbSetPictureColor   [1575, 41,[0.738,0.714,0.417,1 ]];
_index42 =lbAdd   [1575, "РФ Mи-8AMTШ (Серый)                                        					 Цена:   $9,350,000 "];     _Pic35= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vvs">>   "picture"); lbSetPicture    [1575, 42   , _Pic35  ];  lbSetPictureColor   [1575, 42,[0.738,0.714,0.417,1 ]];
_index43 =lbAdd   [1575, "РФ Mи-8AMT (Камо)                                          					 Цена:   $9,000,000 "];     _Pic36= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMT_vvsc">> "picture"); lbSetPicture    [1575, 43   , _Pic36  ];  lbSetPictureColor   [1575, 43,[0.738,0.714,0.417,1 ]];
_index44 =lbAdd   [1575, "РФ Mи-8AMTШ (Камо)                                         					 Цена:   $9,350,000 "];     _Pic37= getText( configFile  >> "CfgVehicles">> "RHS_Mi8AMTSh_vvsc">>  "picture"); lbSetPicture    [1575, 44   , _Pic37  ];  lbSetPictureColor   [1575, 44,[0.738,0.714,0.417,1 ]];
_index45 =lbAdd   [1575, "РФ Mи-8MT                                                  					 Цена:   $9,000,000 "];     _Pic38= getText( configFile  >> "CfgVehicles">> "RHS_Mi8mt_vdv">>  "picture"); lbSetPicture    [1575, 45   , _Pic38  ];  lbSetPictureColor   [1575, 45,[0.738,0.714,0.417,1 ]];
_index46 =lbAdd   [1575, "РФ Mи-8МТВ-3                                               					 Цена:   $9,350,000 "];     _Pic39= getText( configFile  >> "CfgVehicles">> "RHS_Mi8MTV3_vdv">> "picture"); lbSetPicture    [1575, 46   , _Pic39  ];  lbSetPictureColor   [1575, 46,[0.738,0.714,0.417,1 ]];
_index47 =lbAdd   [1575, "РФ Mи-8MT (Серый)                                          					 Цена:   $9,000,000 "];     _Pic40= getText( configFile  >> "CfgVehicles">> "RHS_Mi8mt_vvs">>  "picture"); lbSetPicture    [1575, 47   , _Pic40  ];  lbSetPictureColor   [1575, 47,[0.738,0.714,0.417,1 ]];
_index48 =lbAdd   [1575, "РФ Mи-8МТВ-3 (Серый)                                       					 Цена:   $9,350,000 "];     _Pic41= getText( configFile  >> "CfgVehicles">> "RHS_Mi8MTV3_vvs">> "picture"); lbSetPicture    [1575, 48   , _Pic41  ];  lbSetPictureColor   [1575, 48,[0.738,0.714,0.417,1 ]];
_index49 =lbAdd   [1575, "РФ Mи-8MT (Камо)                                           					 Цена:   $9,000,000 "];     _Pic42= getText( configFile  >> "CfgVehicles">> "RHS_Mi8mt_vvsc">> "picture"); lbSetPicture    [1575, 49   , _Pic42  ];  lbSetPictureColor   [1575, 49,[0.738,0.714,0.417,1 ]];
_index50 =lbAdd   [1575, "РФ Mи-8МТВ-3 (Камо)                                        					 Цена:   $9,350,000 "];     _Pic43= getText( configFile  >> "CfgVehicles">> "RHS_Mi8MTV3_vvsc">>   "picture"); lbSetPicture    [1575, 50   , _Pic43  ];  lbSetPictureColor   [1575, 50,[0.738,0.714,0.417,1 ]];
...
UpgradesOn = 0; 
lbClear 1575;
_index0 =   lbAdd   [1575,"ОБТ M2A1 Сламмер                                             Цена:   $6,000,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "B_MBT_01_cannon_F">> "picture");   lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index1 =   lbAdd   [1575,"СЗО M5 Сэндсторм                                             Цена:   $2,410,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "B_MBT_01_mlrs_F">> "picture"); lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index2 =   lbAdd   [1575,"БТР-Амфибия AMV-7                                            Цена:   $3,150,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "B_APC_Wheeled_01_cannon_F">> "picture");   lbSetPicture    [1575, 2    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index3 =   lbAdd   [1575,"БТР IFV-6c Пантера                                           Цена:   $3,000,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "B_APC_Tracked_01_rcws_F">> "picture"); lbSetPicture    [1575, 3    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
_index4 =   lbAdd   [1575,"ЗСУ IFV-6a Гепард                                            Цена:   $3,800,000.00"]; _Pic5= getText( configFile  >> "CfgVehicles">> "B_APC_Tracked_01_AA_F">> "picture");   lbSetPicture    [1575, 4    , _Pic5   ];  lbSetPictureColor   [1575, 4 ,[0.738,0.714,0.417,1 ]];
_index5 =   lbAdd   [1575,"ОБТ T-100 Варсук                                             Цена:   $6,000,000.00"]; _Pic6= getText( configFile  >> "CfgVehicles">> "O_MBT_02_cannon_F">> "picture");   lbSetPicture    [1575, 5    , _Pic6   ];  lbSetPictureColor   [1575, 5,[0.738,0.714,0.417,1 ]];
_index6 =   lbAdd   [1575,"САУ 2С9 Сокор                                                Цена:   $2,410,000.00"]; _Pic7= getText( configFile  >> "CfgVehicles">> "O_MBT_02_arty_F">> "picture"); lbSetPicture    [1575, 6    , _Pic7   ];  lbSetPictureColor   [1575, 6 ,[0.738,0.714,0.417,1 ]];
_index7 =   lbAdd   [1575,"БТР-Амфибия БТР-К Камыш                                      Цена:   $3,150,000.00"]; _Pic8= getText( configFile  >> "CfgVehicles">> "O_APC_Tracked_02_cannon_F">> "picture");   lbSetPicture    [1575, 7    , _Pic8   ];  lbSetPictureColor   [1575, 7 ,[0.738,0.714,0.417,1 ]];
_index8 =   lbAdd   [1575,"БТР MSE-3 Марид                                              Цена:   $3,000,000.00"]; _Pic9= getText( configFile  >> "CfgVehicles">> "O_APC_Wheeled_02_rcws_F">> "picture"); lbSetPicture    [1575, 8    , _Pic9   ];  lbSetPictureColor   [1575, 8 ,[0.738,0.714,0.417,1 ]];
_index9 =   lbAdd   [1575,"ЗСУ-39 Тигр                                                  Цена:   $3,800,000.00"]; _Pic10= getText( configFile  >> "CfgVehicles">> "O_APC_Tracked_02_AA_F">> "picture");   lbSetPicture    [1575, 9    , _Pic10  ];  lbSetPictureColor   [1575, 9 ,[0.738,0.714,0.417,1 ]];


if (RHS_Support_Enabled == 1) then {
_index10 =lbAdd   [1575,"США (Армия США 2010) САУ M109A6 (WD)                      Цена:   $1,200,000.00"]; _Pic1= getText( configFile  >> "CfgVehicles">> "rhsusf_m109_usarmy_10">> "picture");   lbSetPicture    [1575, 0    , _Pic1   ];  lbSetPictureColor   [1575, 0 ,[0.738,0.714,0.417,1 ]];
_index11 =lbAdd   [1575,"США (Армия США 2010) САУ M109A6 (D)                       Цена:   $1,200,000.00"]; _Pic2= getText( configFile  >> "CfgVehicles">> "rhsusf_m109d_usarmy_10">> "picture");  lbSetPicture    [1575, 1    , _Pic2   ];  lbSetPictureColor   [1575, 1 ,[0.738,0.714,0.417,1 ]];
_index12 =lbAdd   [1575,"США (Армия США 2014) САУ M109A6 (WD)                      Цена:   $1,200,000.00"]; _Pic3= getText( configFile  >> "CfgVehicles">> "rhsusf_m109_usarmy">> "picture");  lbSetPicture    [1575, 2    , _Pic3   ];  lbSetPictureColor   [1575, 2 ,[0.738,0.714,0.417,1 ]];
_index13 =lbAdd   [1575,"США (Армия США 2014) САУ M109A6 (D)                       Цена:   $1,200,000.00"]; _Pic4= getText( configFile  >> "CfgVehicles">> "rhsusf_m109d_usarmy">> "picture"); lbSetPicture    [1575, 3    , _Pic4   ];  lbSetPictureColor   [1575, 3 ,[0.738,0.714,0.417,1 ]];
_index14 =lbAdd   [1575,"США (Армия США 2010) БТР M113A3 (WD)                      Цена:   $1,600,000.00"]; _Pic5= getText( configFile  >> "CfgVehicles">> "rhsusf_m113_usarmy">> "picture");  lbSetPicture    [1575, 4    , _Pic5   ];  lbSetPictureColor   [1575, 4 ,[0.738,0.714,0.417,1 ]];
_index15 =lbAdd   [1575,"США (Армия США 2010) БТР M113A3 (D)                       Цена:   $1,600,000.00"]; _Pic6= getText( configFile  >> "CfgVehicles">> "rhsusf_m113d_usarmy">> "picture"); lbSetPicture    [1575, 5    , _Pic6   ];  lbSetPictureColor   [1575, 5,[0.738,0.714,0.417,1 ]];
_index16 =lbAdd   [1575,"США (Армия США 2010)  M1A1AIM Абрамс                      Цена:   $8,580,000.00"]; _Pic7= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1aimwd_usarmy">> "picture"); lbSetPicture    [1575, 6    , _Pic7   ];  lbSetPictureColor   [1575, 6 ,[0.738,0.714,0.417,1 ]];
_index17 =lbAdd   [1575,"США (Армия США 2010)  M1A1AIM Абрамс (TUSK I)(WD)         Цена:   $8,950,000.00"]; _Pic8= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1aim_tuski_wd">> "picture"); lbSetPicture    [1575, 7    , _Pic8   ];  lbSetPictureColor   [1575, 7 ,[0.738,0.714,0.417,1 ]];
_index18 =lbAdd   [1575,"США (КМП 2010)  M1A1FEP Абрамс  (WD)                      Цена:   $9,110,000.00"]; _Pic9= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1fep_wd">> "picture");   lbSetPicture    [1575, 8    , _Pic9   ];  lbSetPictureColor   [1575, 8 ,[0.738,0.714,0.417,1 ]];
_index19 =lbAdd   [1575,"США (КМП 2010)  M1A1FEP Абрамс (Олива) (WD)               Цена:   $9,110,000.00"]; _Pic10= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1fep_od">> "picture");   lbSetPicture    [1575, 9    , _Pic10  ];  lbSetPictureColor   [1575, 9 ,[0.738,0.714,0.417,1 ]];
_index20 =lbAdd   [1575,"США (Армия США 2010)  M1A1AIM Абрамс (D)                  Цена:   $8,580,000.00"]; _Pic11= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1aimd_usarmy">> "picture");  lbSetPicture    [1575, 10   , _Pic11  ];  lbSetPictureColor   [1575, 10,[0.738,0.714,0.417,1 ]];
_index21 =lbAdd   [1575,"США (Армия США 2010)  M1A1AIM Абрамс (TUSK I)(D)          Цена:   $8,950,000.00"]; _Pic12= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1aim_tuski_d">> "picture");  lbSetPicture    [1575, 11   , _Pic12  ];  lbSetPictureColor   [1575, 11,[0.738,0.714,0.417,1 ]];
_index22 =lbAdd   [1575,"США (КМП 2010)  M1A1FEP Абрамс (D)                        Цена:   $9,110,000.00"]; _Pic13= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a1fep_d">> "picture");    lbSetPicture    [1575, 12   , _Pic13  ];  lbSetPictureColor   [1575, 12,[0.738,0.714,0.417,1 ]];
_index23 =lbAdd   [1575,"США (Армия США 2014) ОБТ M1A2SEPv1 Абрамс (WD)            Цена:   $9,150,000.00"]; _Pic14= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a2sep1wd_usarmy">> "picture");    lbSetPicture    [1575, 13   , _Pic14  ];  lbSetPictureColor   [1575, 13,[0.738,0.714,0.417,1 ]];
_index24 =lbAdd   [1575,"США (Армия США 2014) ОБТ M1A2SEPv1 Абрамс (Tusk I)(WD)    Цена:   $8,600,000.00"]; _Pic15= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a2sep1tuskiwd_usarmy">> "picture");   lbSetPicture    [1575, 14   , _Pic15  ];  lbSetPictureColor   [1575, 14,[0.738,0.714,0.417,1 ]];
_index25 =lbAdd   [1575,"США (Армия США 2014) ОБТ M1A2SEPv1 Абрамс (D)             Цена:   $9,000,000.00"]; _Pic16= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a2sep1d_usarmy">> "picture"); lbSetPicture    [1575, 15   , _Pic16  ];  lbSetPictureColor   [1575, 15,[0.738,0.714,0.417,1 ]];
_index26 =lbAdd   [1575,"США (Армия США 2014) ОБТ M1A2SEPv1 Абрамс (Tusk I)(D)     Цена:   $9,250,000.00"]; _Pic17= getText( configFile  >> "CfgVehicles">> "rhsusf_m1a2sep1tuskid_usarmy">> "picture");    lbSetPicture    [1575, 16   , _Pic17  ];  lbSetPictureColor   [1575, 16,[0.738,0.714,0.417,1 ]];
_index27 =lbAdd   [1575,"США (Армия США 2010) БМП M2A2ODS Брэдли (WD)              Цена:   $3,166,000.00"]; _Pic18= getText( configFile  >> "CfgVehicles">> "rhs_m2a2_wd">> "picture"); lbSetPicture    [1575, 17   , _Pic18  ];  lbSetPictureColor   [1575, 17,[0.738,0.714,0.417,1 ]];
_index28 =lbAdd   [1575,"США (Армия США 2010) БМП M2A2ODS Брэдли (BUSK I)(WD)      Цена:   $3,500,000.00"]; _Pic19= getText( configFile  >> "CfgVehicles">> "rhs_m2a2_buski_wd">> "picture");   lbSetPicture    [1575, 18   , _Pic19  ];  lbSetPictureColor   [1575, 18,[0.738,0.714,0.417,1 ]];
_index29 =lbAdd   [1575,"США (Армия США 2010) БМП M2A2ODS Брэдли (D)               Цена:   $3,166,000.00"]; _Pic20= getText( configFile  >> "CfgVehicles">> "rhs_m2a2">> "picture");    lbSetPicture    [1575, 19   , _Pic20  ];  lbSetPictureColor   [1575, 19,[0.738,0.714,0.417,1 ]];
_index30 =lbAdd   [1575,"США (Армия США 2010) БМП M2A2ODS Брэдли (BUSK I)(WD)      Цена:   $3,500,000.00"]; _Pic21= getText( configFile  >> "CfgVehicles">> "rhs_m2a2_buski">> "picture");  lbSetPicture    [1575, 20   , _Pic21  ];  lbSetPictureColor   [1575, 20,[0.738,0.714,0.417,1 ]];
_index31 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (WD)                 Цена:   $3,566,000.00"]; _Pic22= getText( configFile  >> "CfgVehicles">> "RHS_M2A3_wd">> "picture"); lbSetPicture    [1575, 21   , _Pic22  ];  lbSetPictureColor   [1575, 21,[0.738,0.714,0.417,1 ]];
_index32 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (BUSK I) (WD)        Цена:   $4,000,000.00"]; _Pic23= getText( configFile  >> "CfgVehicles">> "RHS_M2A3_BUSKI_wd">> "picture");   lbSetPicture    [1575, 22   , _Pic23  ];  lbSetPictureColor   [1575, 22,[0.738,0.714,0.417,1 ]];
_index33 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (BUSK III) (WD)      Цена:   $4,500,000.00"]; _Pic24= getText( configFile  >> "CfgVehicles">> "RHS_M2A3_BUSKIII_wd">> "picture"); lbSetPicture    [1575, 23   , _Pic24  ];  lbSetPictureColor   [1575, 23,[0.738,0.714,0.417,1 ]];
_index34 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (D)                  Цена:   $3,566,000.00"]; _Pic25= getText( configFile  >> "CfgVehicles">> "RHS_M2A3">> "picture");    lbSetPicture    [1575, 24   , _Pic25  ];  lbSetPictureColor   [1575, 24,[0.738,0.714,0.417,1 ]];
_index35 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (BUSK I)(D)          Цена:   $4,000,000.00"]; _Pic26= getText( configFile  >> "CfgVehicles">> "RHS_M2A3_BUSKI">> "picture");  lbSetPicture    [1575, 25   , _Pic26  ];  lbSetPictureColor   [1575, 25,[0.738,0.714,0.417,1 ]];
_index36 =lbAdd   [1575,"США (Армия США 2014) БМП M2A3 Брэдли (BUSK III)(D)        Цена:   $4,500,000.00"]; _Pic27= getText( configFile  >> "CfgVehicles">> "RHS_M2A3_BUSKIII">> "picture");    lbSetPicture    [1575, 26   , _Pic27  ];  lbSetPictureColor   [1575, 26,[0.738,0.714,0.417,1 ]];
_index37 =lbAdd   [1575,"США (Армия США 2010) БМП M6 Лэйнбэкер (WD)                Цена:   $3,850,000.00"]; _Pic28= getText( configFile  >> "CfgVehicles">> "rhs_m6_wd_10">> "picture");    lbSetPicture    [1575, 27   , _Pic28  ];  lbSetPictureColor   [1575, 27,[0.738,0.714,0.417,1 ]];
_index38 =lbAdd   [1575,"США (Армия США 2014) БМП M6 Лэйнбэкер (WD)                Цена:   $4,200,000.00"]; _Pic29= getText( configFile  >> "CfgVehicles">> "rhs_m6_wd">> "picture");   lbSetPicture    [1575, 28   , _Pic29  ];  lbSetPictureColor   [1575, 28,[0.738,0.714,0.417,1 ]];
_index39 =lbAdd   [1575,"США (Армия США 2010) БМП M6 Лэйнбэкер (D)                 Цена:   $3,850,000.00"]; _Pic30= getText( configFile  >> "CfgVehicles">> "rhs_m6_10">> "picture");   lbSetPicture    [1575, 29   , _Pic30  ];  lbSetPictureColor   [1575, 29,[0.738,0.714,0.417,1 ]];
_index40 =lbAdd   [1575,"США (Армия США 2014) БМП M6 Лэйнбэкер (D)                 Цена:   $4,200,000.00"]; _Pic31= getText( configFile  >> "CfgVehicles">> "rhs_m6">> "picture");  lbSetPicture    [1575, 30   , _Pic31  ];  lbSetPictureColor   [1575, 30,[0.738,0.714,0.417,1 ]];
_index41 =lbAdd   [1575,"РФ ПТ САУ 2С25 Спрут-СД                                   Цена:     $945,000.00"]; _Pic32= getText( configFile  >> "CfgVehicles">> "rhs_sprut_vdv">> "picture");   lbSetPicture    [1575, 31   , _Pic32  ];  lbSetPictureColor   [1575, 31,[0.738,0.714,0.417,1 ]];
_index42 =lbAdd   [1575,"РФ САУ 2С3М Акация                                        Цена:   $4,300,500.00"]; _Pic33= getText( configFile  >> "CfgVehicles">> "rhs_2s3_tv">> "picture");  lbSetPicture    [1575, 32   , _Pic33  ];  lbSetPictureColor   [1575, 32,[0.738,0.714,0.417,1 ]];
_index43 =lbAdd   [1575,"РФ СЗО БМ-21 Град                                         Цена:   $7,580,000.00"]; _Pic34= getText( configFile  >> "CfgVehicles">> "RHS_BM21_MSV_01">> "picture"); lbSetPicture    [1575, 33   , _Pic34  ];  lbSetPictureColor   [1575, 33,[0.738,0.714,0.417,1 ]];
_index44 =lbAdd   [1575,"РФ БМД-1                                                  Цена:   $1,350,000.00"]; _Pic35= getText( configFile  >> "CfgVehicles">> "rhs_bmd1">> "picture");    lbSetPicture    [1575, 34   , _Pic35  ];  lbSetPictureColor   [1575, 34,[0.738,0.714,0.417,1 ]];
_index45 =lbAdd   [1575,"РФ БМД-1K                                                 Цена:   $1,375,000.00"]; _Pic36= getText( configFile  >> "CfgVehicles">> "rhs_bmd1k">> "picture");   lbSetPicture    [1575, 35   , _Pic36  ];  lbSetPictureColor   [1575, 35,[0.738,0.714,0.417,1 ]];
_index46 =lbAdd   [1575,"РФ БМД-1П                                                 Цена:   $1,450,000.00"]; _Pic37= getText( configFile  >> "CfgVehicles">> "rhs_bmd1p">> "picture");   lbSetPicture    [1575, 36   , _Pic37  ];  lbSetPictureColor   [1575, 36,[0.738,0.714,0.417,1 ]];
_index47 =lbAdd   [1575,"РФ БМД-1ПК                                                Цена:   $1,525,000.00"]; _Pic38= getText( configFile  >> "CfgVehicles">> "rhs_bmd1pk">> "picture");  lbSetPicture    [1575, 37   , _Pic38  ];  lbSetPictureColor   [1575, 37,[0.738,0.714,0.417,1 ]];
_index48 =lbAdd   [1575,"РФ БМД-1Р                                                 Цена:   $1,450,000.00"]; _Pic39= getText( configFile  >> "CfgVehicles">> "rhs_bmd1r">> "picture");   lbSetPicture    [1575, 38   , _Pic39  ];  lbSetPictureColor   [1575, 38,[0.738,0.714,0.417,1 ]];
_index49 =lbAdd   [1575,"РФ БМД-2                                                  Цена:   $1,650,000.00"]; _Pic40= getText( configFile  >> "CfgVehicles">> "rhs_bmd2">> "picture");    lbSetPicture    [1575, 39   , _Pic40  ];  lbSetPictureColor   [1575, 39,[0.738,0.714,0.417,1 ]];
_index50 =lbAdd   [1575,"РФ БМД-2К                                                 Цена:   $1,850,000.00"]; _Pic41= getText( configFile  >> "CfgVehicles">> "rhs_bmd2k">> "picture");   lbSetPicture    [1575, 40   , _Pic41  ];  lbSetPictureColor   [1575, 40,[0.738,0.714,0.417,1 ]];
_index51 =lbAdd   [1575,"РФ БМД-2М                                                 Цена:   $1,875,000.00"]; _Pic42= getText( configFile  >> "CfgVehicles">> "rhs_bmd2m">> "picture");   lbSetPicture    [1575, 41   , _Pic42  ];  lbSetPictureColor   [1575, 41,[0.738,0.714,0.417,1 ]];
_index52 =lbAdd   [1575,"РФ БМД-4                                                  Цена:   $2,210,000.00"]; _Pic43= getText( configFile  >> "CfgVehicles">> "rhs_bmd4_vdv">> "picture");    lbSetPicture    [1575, 42   , _Pic43  ];  lbSetPictureColor   [1575, 42,[0.738,0.714,0.417,1 ]];
_index53 =lbAdd   [1575,"РФ БМД-4М                                                 Цена:   $2,225,000.00"]; _Pic44= getText( configFile  >> "CfgVehicles">> "rhs_bmd4m_vdv">> "picture");   lbSetPicture    [1575, 43   , _Pic44  ];  lbSetPictureColor   [1575, 43,[0.738,0.714,0.417,1 ]];
_index54 =lbAdd   [1575,"РФ БМД-4М (А)                                             Цена:   $2,275,000.00"]; _Pic45= getText( configFile  >> "CfgVehicles">> "rhs_bmd4ma_vdv">> "picture");  lbSetPicture    [1575, 44   , _Pic45  ];  lbSetPictureColor   [1575, 44,[0.738,0.714,0.417,1 ]];
_index55 =lbAdd   [1575,"РФ БМП-1                                                  Цена:   $2,500,000.00"]; _Pic46= getText( configFile  >> "CfgVehicles">> "rhs_bmp1_VDV">> "picture");    lbSetPicture    [1575, 45   , _Pic46  ];  lbSetPictureColor   [1575, 45,[0.738,0.714,0.417,1 ]];
_index56 =lbAdd   [1575,"РФ БМП-1П                                                 Цена:   $2,575,000.00"]; _Pic47= getText( configFile  >> "CfgVehicles">> "rhs_bmp1p_VDV">> "picture");   lbSetPicture    [1575, 46   , _Pic47  ];  lbSetPictureColor   [1575, 46,[0.738,0.714,0.417,1 ]];
_index57 =lbAdd   [1575,"РФ БМП-1K                                                 Цена:   $2,625,000.00"]; _Pic48= getText( configFile  >> "CfgVehicles">> "rhs_bmp1k_VDV">> "picture");   lbSetPicture    [1575, 47   , _Pic48  ];  lbSetPictureColor   [1575, 47,[0.738,0.714,0.417,1 ]];
_index58 =lbAdd   [1575,"РФ БМП-1Д                                                 Цена:   $2,650,000.00"]; _Pic49= getText( configFile  >> "CfgVehicles">> "rhs_bmp1d_VDV">> "picture");   lbSetPicture    [1575, 48   , _Pic49  ];  lbSetPictureColor   [1575, 48,[0.738,0.714,0.417,1 ]];
_index59 =lbAdd   [1575,"РФ БМП-2 (E)                                              Цена:   $2,655,000.00"]; _Pic50= getText( configFile  >> "CfgVehicles">> "rhs_bmp2e_VDV">> "picture");   lbSetPicture    [1575, 49   , _Pic50  ];  lbSetPictureColor   [1575, 49,[0.738,0.714,0.417,1 ]];
_index60 =lbAdd   [1575,"РФ БМП-2                                                  Цена:   $2,675,000.00"]; _Pic51= getText( configFile  >> "CfgVehicles">> "rhs_bmp2_VDV">> "picture");    lbSetPicture    [1575, 50   , _Pic51  ];  lbSetPictureColor   [1575, 50,[0.738,0.714,0.417,1 ]];
_index61 =lbAdd   [1575,"РФ БМП-2K                                                 Цена:   $2,710,000.00"]; _Pic52= getText( configFile  >> "CfgVehicles">> "rhs_bmp2k_VDV">> "picture");   lbSetPicture    [1575, 51   , _Pic52  ];  lbSetPictureColor   [1575, 51,[0.738,0.714,0.417,1 ]];
_index62 =lbAdd   [1575,"РФ БМП-2Д                                                 Цена:   $2,745,000.00"]; _Pic53= getText( configFile  >> "CfgVehicles">> "rhs_bmp2d_VDV">> "picture");   lbSetPicture    [1575, 52   , _Pic53  ];  lbSetPictureColor   [1575, 52,[0.738,0.714,0.417,1 ]];
_index63 =lbAdd   [1575,"РФ БРМ-1K                                                 Цена:   $2,847,650.00"]; _Pic54= getText( configFile  >> "CfgVehicles">> "rhs_brm1k_msv">> "picture");   lbSetPicture    [1575, 53   , _Pic54  ];  lbSetPictureColor   [1575, 53,[0.738,0.714,0.417,1 ]];
_index64 =lbAdd   [1575,"РФ БТР-60                                                 Цена:   $2,500,000.00"]; _Pic55= getText( configFile  >> "CfgVehicles">> "rhs_btr60_msv">> "picture");   lbSetPicture    [1575, 54   , _Pic55  ];  lbSetPictureColor   [1575, 54,[0.738,0.714,0.417,1 ]];
_index65 =lbAdd   [1575,"РФ БТР-70                                                 Цена:   $2,750,000.00"]; _Pic56= getText( configFile  >> "CfgVehicles">> "rhs_btr70_msv">> "picture");   lbSetPicture    [1575, 55   , _Pic56  ];  lbSetPictureColor   [1575, 55,[0.738,0.714,0.417,1 ]];
_index66 =lbAdd   [1575,"РФ БТР-80                                                 Цена:   $3,000,000.00"]; _Pic57= getText( configFile  >> "CfgVehicles">> "rhs_btr80_msv">> "picture");   lbSetPicture    [1575, 56   , _Pic57  ];  lbSetPictureColor   [1575, 56,[0.738,0.714,0.417,1 ]];
_index67 =lbAdd   [1575,"РФ БТР-80A                                                Цена:   $3,110,000.00"]; _Pic58= getText( configFile  >> "CfgVehicles">> "rhs_btr80a_msv">> "picture");  lbSetPicture    [1575, 57   , _Pic58  ];  lbSetPictureColor   [1575, 57,[0.738,0.714,0.417,1 ]];
_index68 =lbAdd   [1575,"РФ ПРП-3                                                  Цена:   $1,525,375.00"]; _Pic59= getText( configFile  >> "CfgVehicles">> "rhs_prp3_msv">> "picture");    lbSetPicture    [1575, 58   , _Pic59  ];  lbSetPictureColor   [1575, 58,[0.738,0.714,0.417,1 ]];
_index69 =lbAdd   [1575,"РФ T-72Б (обр. 1984г.)                                    Цена:   $4,250,000.00"]; _Pic60= getText( configFile  >> "CfgVehicles">> "rhs_t72ba_tv">> "picture");    lbSetPicture    [1575, 59   , _Pic60  ];  lbSetPictureColor   [1575, 59,[0.738,0.714,0.417,1 ]];
_index70 =lbAdd   [1575,"РФ T-72Б (обр. 1985г.)                                    Цена:   $4,550,000.00"]; _Pic61= getText( configFile  >> "CfgVehicles">> "rhs_t72bb_tv">> "picture");    lbSetPicture    [1575, 60   , _Pic61  ];  lbSetPictureColor   [1575, 60,[0.738,0.714,0.417,1 ]];
_index71 =lbAdd   [1575,"РФ T-72Б (обр. 1989г.                                     Цена:   $4,725,000.00"]; _Pic62= getText( configFile  >> "CfgVehicles">> "rhs_t72bc_tv">> "picture");    lbSetPicture    [1575, 61   , _Pic62  ];  lbSetPictureColor   [1575, 61,[0.738,0.714,0.417,1 ]];
_index72 =lbAdd   [1575,"РФ T-72Б3 (обр. 2012г.)                                   Цена:   $7,850,000.00"]; _Pic63= getText( configFile  >> "CfgVehicles">> "rhs_t72bd_tv">> "picture");    lbSetPicture    [1575, 62   , _Pic63  ];  lbSetPictureColor   [1575, 62,[0.738,0.714,0.417,1 ]];
_index73 =lbAdd   [1575,"РФ T-80                                                   Цена:   $6,250,450.00"]; _Pic64= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture"); lbSetPicture    [1575, 63   , _Pic64  ];  lbSetPictureColor   [1575, 63,[0.738,0.714,0.417,1 ]];
_index74 =lbAdd   [1575,"РФ T-80A                                                  Цена:   $6,300,500.00"]; _Pic65= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");    lbSetPicture    [1575, 64   , _Pic65  ];  lbSetPictureColor   [1575, 64,[0.738,0.714,0.417,1 ]];
_index75 =lbAdd   [1575,"РФ T-80Б                                                  Цена:   $6,400,000.00"]; _Pic66= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");    lbSetPicture    [1575, 65   , _Pic66  ];  lbSetPictureColor   [1575, 65,[0.738,0.714,0.417,1 ]];
_index76 =lbAdd   [1575,"РФ T-80БK                                                 Цена:   $6,410,000.00"]; _Pic67= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");   lbSetPicture    [1575, 66   , _Pic67  ];  lbSetPictureColor   [1575, 66,[0.738,0.714,0.417,1 ]];
_index77 =lbAdd   [1575,"РФ T-80БВ                                                 Цена:   $6,450,000.00"]; _Pic68= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");   lbSetPicture    [1575, 67   , _Pic68  ];  lbSetPictureColor   [1575, 67,[0.738,0.714,0.417,1 ]];
_index78 =lbAdd   [1575,"РФ T-80БВK                                                Цена:   $6,500,000.00"]; _Pic69= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");  lbSetPicture    [1575, 68   , _Pic69  ];  lbSetPictureColor   [1575, 68,[0.738,0.714,0.417,1 ]];
_index79 =lbAdd   [1575,"РФ T-80У                                                  Цена:   $6,525,000.00"]; _Pic70= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");    lbSetPicture    [1575, 69   , _Pic70  ];  lbSetPictureColor   [1575, 69,[0.738,0.714,0.417,1 ]];
_index80 =lbAdd   [1575,"РФ T-80УE1                                                Цена:   $6,550,000.00"]; _Pic71= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");  lbSetPicture    [1575, 70   , _Pic71  ];  lbSetPictureColor   [1575, 70,[0.738,0.714,0.417,1 ]];
_index81 =lbAdd   [1575,"РФ T-80У45M                                               Цена:   $6,575,000.00"]; _Pic72= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture"); lbSetPicture    [1575, 71   , _Pic72  ];  lbSetPictureColor   [1575, 71,[0.738,0.714,0.417,1 ]];
_index82 =lbAdd   [1575,"РФ T-80УM                                                 Цена:   $6,600,000.00"]; _Pic73= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");   lbSetPicture    [1575, 72   , _Pic73  ];  lbSetPictureColor   [1575, 72,[0.738,0.714,0.417,1 ]];
_index83 =lbAdd   [1575,"РФ ЗСУ-23-4 (ТВ)                                          Цена:   $6,500,000.00"]; _Pic74= getText( configFile  >> "CfgVehicles">> "rhs_t80">> "picture");   lbSetPicture    [1575, 73   , _Pic74  ];  lbSetPictureColor   [1575, 73,[0.738,0.714,0.417,1 ]];
