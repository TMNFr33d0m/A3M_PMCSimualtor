...
class CfgPatches
{
	...
	{
		units[]={};
		weapons[]={"A3M_FNFal", "A3M_FNFal_Mod1"};
		requiredVersion=0.1;
...
class CfgWeapons
{
	...
	class A3M_FNFal_Base_F: Rifle_Base_F /// Just basic values common for all testing rifle variants
	{
		magazines[] = {A3M_20rnd_FAL, A3M_100rnd_FAL, A3M_FNFAL_Mags}; /// original custom made magazines and a group of several standardized mags
...
/////////////////////////////////////////////////////  I R O N S I G H T S  /////////////////////////////////////////////////////
		...
		descriptionShort = "DSA SA58 FAL"; /// displayed on mouseOver in Inventory
		handAnim[] = {"OFP2_ManSkeleton", "\A3\Weapons_F\Rifles\MX\data\Anim\mx_afg.rtm"}; 
		dexterity = 1.55;	// 4,5kg weight
...
//caseless ammo//
	...
	class A3M_FullAuto_MRange: fullauto_medium { /// Pew, pew, fucking pew only for A3M APFC AI
			showToPlayer = 0;
			burst = "5 + round random 10";
			
			minRange = 0; minRangeProbab = 0.4;
			midRange = 80; midRangeProbab = 0.5;
	...
	class A3M_FullAuto_LRange: fullauto_medium { /// Pew, pew, fucking pew only for A3M APFC AI (Long Range) 
	...
	class A3M_DSA_SA58_FAL: A3M_FNFal_Base_F
	{	scope = 2; /// should be visible and useable in game
		displayName = "DSA SA-58 FAL"; /// some name
		model = "\A3M_FNFAL\A3M_FN_FAL.p3d"; /// path to model

		picture = "\A3\weapons_f_epb\rifles\mx_black\data\ui\gear_mx_cqc_black_m_ca.paa"; /// different accessories have M, S, T instead of X
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			mass = 90; /// some rough estimate
		};
	};
	
	class A3M_DSA_SA58_FAL_Mod1: A3M_FNFal_Base_F
	{	scope = 2; /// should be visible and useable in game
		displayName = "DSA SA-58 FAL (Modded Sear)"; /// some name
		model = "\A3M_FNFAL\A3M_FN_FAL.p3d"; /// path to model
